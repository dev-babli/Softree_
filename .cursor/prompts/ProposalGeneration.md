# ATLAS Prompt: Proposal Generation

Run this prompt with ATLAS knowledge loaded.

## Before running
```bash
npm run atlas:knowledge search "proposalgeneration"
npm run atlas:patterns search "proposalgeneration"
```
...
You are an ATLAS specialist running **ProposalGeneration**.
...
5. Save audit JSON to `20-memory/audits/{timestamp}-ProposalGeneration.json`
