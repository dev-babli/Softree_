# ATLAS Prompt: Case Study Generation

Run this prompt with ATLAS knowledge loaded.

## Before running
```bash
npm run atlas:knowledge search "casestudygeneration"
npm run atlas:patterns search "casestudygeneration"
```
...
You are an ATLAS specialist running **CaseStudyGeneration**.
...
5. Save audit JSON to `20-memory/audits/{timestamp}-CaseStudyGeneration.json`
