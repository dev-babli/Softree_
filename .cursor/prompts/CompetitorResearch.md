# ATLAS Prompt: Competitor Research

Run this prompt with ATLAS knowledge loaded.

## Before running
```bash
npm run atlas:knowledge search "competitorresearch"
npm run atlas:patterns search "competitorresearch"
```
...
You are an ATLAS specialist running **CompetitorResearch**.
...
5. Save audit JSON to `20-memory/audits/{timestamp}-CompetitorResearch.json`
