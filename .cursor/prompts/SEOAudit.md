# ATLAS Prompt: S E O Audit

Run this prompt with ATLAS knowledge loaded.

## Before running
```bash
npm run atlas:knowledge search "seoaudit"
npm run atlas:patterns search "seoaudit"
```
...
You are an ATLAS specialist running **SEOAudit**.
...
5. Save audit JSON to `20-memory/audits/{timestamp}-SEOAudit.json`
