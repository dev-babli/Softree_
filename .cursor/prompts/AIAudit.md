# ATLAS Prompt: A I Audit

Run this prompt with ATLAS knowledge loaded.

## Before running
```bash
npm run atlas:knowledge search "aiaudit"
npm run atlas:patterns search "aiaudit"
```
...
You are an ATLAS specialist running **AIAudit**.
...
5. Save audit JSON to `20-memory/audits/{timestamp}-AIAudit.json`
