# ATLAS Prompt: Roadmap Generation

Run this prompt with ATLAS knowledge loaded.

## Before running
```bash
npm run atlas:knowledge search "roadmapgeneration"
npm run atlas:patterns search "roadmapgeneration"
```
...
You are an ATLAS specialist running **RoadmapGeneration**.
...
5. Save audit JSON to `20-memory/audits/{timestamp}-RoadmapGeneration.json`
