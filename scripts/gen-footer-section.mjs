/**
 * Generate FooterSection.tsx from extracted footer.html
 * Uses space-preserving, amp-safe conversion.
 */
...
const htmlPath = path.resolve("src/components/client-exact/_extracted/sections/footer.html")
let html = fs.readFileSync(htmlPath, "utf8").replace(/&amp;amp;/g, "&amp;")
const root = parse(html, { comment: false })
const el = root.childNodes.find((n) => n.nodeType === 1)
const body = nodeToJsx(el, 2).trimEnd()
const tsx = `"use client"

/** Footer — exact Framer Desktop XL from Softree_/client.html */
...
`
const out = path.resolve("src/components/client-exact/sections/FooterSection.tsx")
