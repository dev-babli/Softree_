...
const m = t.match(/export const SOFTREE_AGENTIC_INTERACTION_SCRIPT = "([\s\S]*)";/)
if (!m) throw new Error("no script")
const script = m[1].replace(/\\n/g, "\n").replace(/\\"/g, '"')
fs.writeFileSync(".planning/page-forge/softree-agentic-exact/interaction-script.js", script)
