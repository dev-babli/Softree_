...
**N/A for exact reference mode** — page intentionally reproduces Softree reference composition. Not evaluated as original Softree marketing.
...
### P1
- `src/components/softree-agentic-exact/SoftreeAgenticHeroSection.tsx` — `<img>` warnings (accepted for exact CDN asset fidelity)
