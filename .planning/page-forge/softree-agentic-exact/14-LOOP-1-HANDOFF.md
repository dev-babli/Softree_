...
1. **P0:** CSS `opacity: 1 !important` fought GSAP during handoff → swap `softree-agentic-k2-loader-running` to `softree-agentic-k2-handoff-running` with `opacity: unset`
