...
| `softree-agentic-page-fix.css` | Hero copy lock post-intro; removed handoff flip `hidden !important` |
| `k2LoaderRuntime.ts` | Idempotent `finish()`; clears handoff class + hardStop |
| `SoftreeAgenticPage.tsx` | Exclude `#meet-artemis` from scroll reveal |
