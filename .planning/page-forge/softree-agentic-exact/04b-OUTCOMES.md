...
- `src/components/softree-agentic-exact/SoftreeAgenticOutcomesSection.tsx`
- Wired through `SoftreeAgenticOutcomesSection` in `src/components/softree-agentic-exact/sections.tsx`
...
- Fresh route check: `/agentic-ai-platform` returned `200`
...
- Screenshot: `.planning/page-forge/softree-agentic-exact/outcomes-component-pass-fixed.png`
...
- Fixed by moving the original K2 card geometry and scroll progress behavior into `SoftreeAgenticOutcomesSection`.
