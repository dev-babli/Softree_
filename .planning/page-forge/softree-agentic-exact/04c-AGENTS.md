...
- `src/components/softree-agentic-exact/SoftreeAgenticAgentsSection.tsx`
- Wired through `SoftreeAgenticAgentsSection` in `src/components/softree-agentic-exact/sections.tsx`
...
- Screenshots:
  - `.planning/page-forge/softree-agentic-exact/agents-technical-pass.png`
  - `.planning/page-forge/softree-agentic-exact/agents-business-pass.png`
