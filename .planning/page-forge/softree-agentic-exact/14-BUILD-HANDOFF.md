...
| File | Change |
| --- | --- |
| `SoftreeAgenticLoader.tsx` | Perspective stage wrapper; shared `SOFTREE_AGENTIC_HERO_BG_IMAGE`; portal via `useSyncExternalStore` |
...
| `softree-agentic-page-fix.css` | GSAP handoff no longer fights `!important` opacity rules |
