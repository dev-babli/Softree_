...
- `src/components/softree-agentic-exact/SoftreeAgenticHeroSection.tsx`
- Wired through `SoftreeAgenticMeetSection` in `src/components/softree-agentic-exact/sections.tsx`

## Preserved Elements

- Original hero section id/classes/data-scroll state
- Hero background image and overlay
- Label: `Softree Agent Platform`
...
- `npx tsc --noEmit --pretty false`: repo has pre-existing errors, none reported for `SoftreeAgenticHeroSection.tsx` or `sections.tsx`
- Fresh dev route check: `/agentic-ai-platform` returned `200`
...
- Screenshot: `.planning/page-forge/softree-agentic-exact/hero-component-pass.png`
