  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-accent disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-transparent shadow-sm hover:bg-surface-elevated hover:text-accent",
        secondary:
          "bg-surface-elevated text-text-primary shadow-sm hover:bg-surface-card",
        ghost: "hover:bg-surface-elevated hover:text-accent",
