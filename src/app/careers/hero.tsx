      ...
      <div style={s.body}>
        ...
        <div style={{
          ...
          <div style={s.searchBox}>
            <span style={s.searchIconLeft}>⌕</span>
            <input
              style={s.searchInput}
            ...
            <button style={s.searchBtn}>Search jobs</button>
          </div>
          <div style={s.quickTags}>
            <span style={s.quickLabel}>Popular:</span>
            {TAGS.map((t) => (
              <button key={t} style={s.quickTag} onClick={() => setSearchQuery(t)}>
                {t}
              </button>
            ))}
          </div>
