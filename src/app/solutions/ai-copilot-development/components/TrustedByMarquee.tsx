...
export function TrustedByMarquee() {
  ...
  return (
    <section className="w-full bg-gradient-to-b from-zinc-50 via-white to-zinc-50 py-6 sm:py-8 md:py-10 overflow-hidden">
      {/* Tag row */}
      <div className="flex items-center justify-center gap-3 sm:gap-4 mb-8 sm:mb-10 px-4">
        ...
        <div className="flex items-center gap-2 sm:gap-3">
          ...
          <span className="inline-flex items-center rounded-full bg-[#FF5812] px-3 py-1 sm:px-4 sm:py-1.5">
            <span className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-white">Global Enterprises</span>
          </span>
        </div>
        <div className="h-px flex-1 max-w-[120px] bg-black/10" />
      </div>
      ...
      <div className="relative w-full overflow-hidden">
        {/* Fade edges */}
        <div className="pointer-events-none absolute inset-y-0 left-0 z-10 w-16 sm:w-24 bg-linear-to-r from-zinc-50 to-transparent" />
        <div className="pointer-events-none absolute inset-y-0 right-0 z-10 w-16 sm:w-24 bg-linear-to-l from-zinc-50 to-transparent" />
