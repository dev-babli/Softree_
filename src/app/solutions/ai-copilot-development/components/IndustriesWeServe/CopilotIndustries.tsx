    ...
    <section className="relative py-12 md:py-16 lg:py-20 overflow-hidden bg-white">
      <div className="relative z-10">
        ...
        <div className="text-center max-w-4xl mx-auto mb-6 lg:mb-8 px-4">
          ...
          >
            Industry-Specific <span className="text-[#FF5812]">AI Copilot Development Solutions</span>
          </motion.h2>
          ...
          >
            Empower every industry with custom AI copilots that automate workflows, streamline knowledge access, enhance employee productivity, and improve customer experiences. Softree develops secure enterprise AI copilots tailored to the unique requirements of healthcare, manufacturing, finance, retail, logistics, education, and more.
          </motion.p>
        </div>
