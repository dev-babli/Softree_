...
import { copilotCapabilitiesData } from './copilotCapabilitiesData';

export default function CopilotCapabilities() {
  const [activeIndex, setActiveIndex] = useState(1); // Default to 02 (index 1) as requested
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setActiveIndex((prev) => (prev + 1) % copilotCapabilitiesData.length);
    }, 2500);
  ...
  const activeData = copilotCapabilitiesData[activeIndex];
      ...
      <div className="relative z-10 max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center w-full mb-8 lg:mb-10">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-[2.5rem] font-extrabold text-[#111827] mb-3 tracking-tight text-center leading-tight">
            Enterprise AI <span className="text-[#FF6B2C]">Copilot Development Capabilities</span>
          </h2>

          <p className="text-[15px] lg:text-[17px] text-[#6B7280] text-center max-w-2xl leading-snug">
            Partner with Softree to design, develop, deploy, and optimize enterprise AI copilots using Microsoft Copilot Studio, Azure AI, OpenAI, and Power Platform. We build secure, scalable AI assistants that automate business processes, improve employee productivity, and integrate seamlessly with enterprise systems.
          </p>
        </div>
        ...
        >
          ...
          <div className="w-full lg:w-[40%] flex flex-col gap-2 lg:gap-3 relative z-10">
            {copilotCapabilitiesData.map((cap, idx) => {
