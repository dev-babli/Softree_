...
const steps = [
  {
    ...
    leftCard: {
      ...
      points: [
        ...
        "Automate repetitive employee requests",
  ...
  },
  {
    ...
    leftCard: {
      ...
      points: [
        "Connect SharePoint and Microsoft 365",
    ...
    rightCard: {
      title: "Business Impact",
      points: [
        "Reduce search time for information",
  ...
  },
  {
    ...
    leftCard: {
      ...
      points: [
        "Automate approvals and business tasks",
  ...
  },
  {
    ...
    leftCard: {
      ...
      points: [
        "AI-powered 24/7 customer assistance",
...
export default function CopilotOutcomes() {
  const [activeIndex, setActiveIndex] = useState(3); // Default to 04 (index 3)
  ...
  return (
    <section className="relative overflow-hidden bg-transparent py-10 md:py-16">
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-12">
        ...
        <div className="mx-auto mb-16 max-w-4xl text-center">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-[2.5rem] font-bold text-gray-900 tracking-tight mb-6 max-w-6xl mx-auto leading-tight">
            Drive Measurable Business Outcomes with <span className="text-[#FF5812]">Enterprise AI Copilots</span>
          </h2>
          <p className="text-[15px] lg:text-[17px] text-gray-500 max-w-3xl mx-auto leading-relaxed">
            Our AI Copilot Development services help organizations improve employee productivity, accelerate decision-making, automate knowledge discovery, and deliver exceptional customer experiences through secure, enterprise-grade AI copilots built with Microsoft Copilot Studio and Azure AI.
          </p>
        </div>
