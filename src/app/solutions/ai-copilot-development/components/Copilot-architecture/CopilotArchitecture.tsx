...
const FEATURE_BLOCKS = [
  {
    icon: <BrainCircuit className="w-8 h-8 text-gray-800" />,
    title: "LLM",
    subtitle: "Processes prompts and generates intelligent responses.",
  },
  {
    icon: <Wand2 className="w-8 h-8 text-orange-600" />,
    title: "Prompt Engine",
    subtitle: "Builds optimized prompts and injects enterprise context.",
  },
  {
    icon: <FileCheck className="w-8 h-8 text-gray-800" />,
    title: "Business Logic",
    subtitle: "Applies approval logic, permissions, and enterprise workflows.",
  },
  {
    icon: <Bot className="w-8 h-8 text-blue-600" />,
    title: "AI Agent",
    subtitle: "Executes actions, retrieves data, and automates business processes.",
  },
  {
    icon: <Share2 className="w-8 h-8 text-red-500" />,
    title: "Integrations",
    subtitle: "Connects Microsoft 365, Dynamics 365, SharePoint, ERP, CRM, and APIs.",
  },
  {
    icon: <Database className="w-8 h-8 text-orange-500" />,
    title: "Memory",
    subtitle: "Maintains conversation history, retrieves documents, and provides contextual responses.",
  },
];
...
const PLATFORMS = [
  ...
  { icon: <Code className="w-6 h-6" />, label: "REST APIs", color: "text-gray-900" },
        ...
        >
          ...
          <motion.div variants={fadeUpVariant} className="text-center mb-16">
            <div className="flex items-center justify-center gap-6 mb-6">
              ...
              <span className="text-[#FF5812] font-bold tracking-[0.2em] text-sm uppercase">AI COPILOT ARCHITECTURE</span>
              <div className="animate-line-stretch flex items-center relative h-[1.5px] bg-[#FF5812]">
            ...
            <p className="text-lg md:text-xl text-gray-500 max-w-3xl mx-auto leading-relaxed">
              A secure, scalable, and intelligent AI Copilot architecture that connects large language models, enterprise knowledge, Microsoft business applications, and automation services to deliver conversational AI experiences across your organization.
            </p>
          </motion.div>
          ...
          <div className="relative w-full flex flex-col items-center">
              ...
              <div className="relative group bg-white/90 backdrop-blur-md border border-[#FF5812]/20 rounded-[28px] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgba(255,88,18,0.1)] hover:border-[#FF5812]/40 transition-all duration-300 flex items-center gap-6 cursor-default">
                ...
                <div className="relative flex-shrink-0 w-16 h-16 rounded-full bg-orange-50 border border-orange-100 flex items-center justify-center">
                  ...
                  <motion.div animate={floatAnimation}>
                    <MessageSquare className="w-8 h-8 text-[#FF5812]" />
                  </motion.div>
                </div>
                <div>
                  <h3 className="text-xl font-bold text-gray-900 mb-1">User Query</h3>
                  <p className="text-sm text-gray-500">Employees, customers, or business users interact with the AI Copilot using natural language.</p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="relative group bg-white/90 backdrop-blur-md border border-[#FF5812]/20 rounded-[28px] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_40px_rgba(255,88,18,0.15)] hover:border-[#FF5812]/40 transition-all duration-300 flex items-center gap-6 cursor-default overflow-hidden">
                ...
                <div className="relative z-10 flex-shrink-0 w-20 h-20 rounded-full bg-orange-50 border border-orange-100 flex items-center justify-center shadow-inner">
                  ...
                  <motion.div animate={floatAnimation}>
                    <Bot className="w-10 h-10 text-[#FF5812]" />
                  </motion.div>
                </div>
                <div className="relative z-10 pr-12">
                  <h3 className="text-xl font-bold text-gray-900 mb-2">Enterprise AI Copilot</h3>
                  <p className="text-sm text-gray-500 leading-relaxed">
                    Understands intent, retrieves enterprise knowledge, reasons using AI models, and generates intelligent responses or business actions.
                  </p>
                </div>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-white/90 backdrop-blur-md border border-gray-200/60 rounded-[28px] p-6 lg:p-8 shadow-[0_10px_40px_rgb(0,0,0,0.04)] hover:shadow-[0_15px_50px_rgba(0,0,0,0.06)] transition-all duration-300">
                <div className="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-6 gap-6 lg:gap-0 lg:divide-x divide-gray-100">
