        ...
        >
          ...
          <motion.div variants={fadeUpVariant} className="text-center mb-4">
            ...
            <p className="text-[15px] lg:text-base text-[#6B7280] mb-6 lg:mb-8 text-center max-w-2xl mx-auto leading-relaxed">
              Explore Softree LangGraph development case studies—stateful agent graphs, multi-agent teams, and tool integrations that deliver measurable operational outcomes.
            </p>
          </motion.div>
