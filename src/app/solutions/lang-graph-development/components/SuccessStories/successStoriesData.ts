...
export const successStoriesList: SuccessStory[] = [
  {
    ...
    title: 'LangGraph HR Agent Team',
    problem:
      'Employees waited on HR for policy and leave questions scattered across documents and email.',
    solution:
      'A RAG-grounded LangGraph multi-agent flow with tool calling for common HR requests and scoped access to approved content.',
    results: [
  ...
  },
  {
    ...
    title: 'LangGraph Performance Insights Pipeline',
    problem:
      'Teams spent days manually reviewing sites for conversion, UX, and SEO issues.',
    solution:
      'Softree built a LangGraph multi-step agent pipeline that analyzes signals and produces an actionable performance report in minutes.',
