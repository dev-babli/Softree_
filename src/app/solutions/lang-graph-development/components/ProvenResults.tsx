...
const provenResults = [
  {
    ...
    title: "LangGraph Knowledge Agent Team",
    challenge:
      "Employees could not find trusted answers across scattered policy and knowledge repositories.",
    solution:
      "Built a permission-aware LangGraph agent graph with hybrid retrieval grounded in approved content and cited sources.",
    outcome:
  ...
  {
    category: "OPERATIONS",
    title: "LangGraph Document Processing Graph",
    challenge:
      "Teams manually reviewed long contracts and operational documents.",
    solution:
      "Combined document loaders with LangGraph summarization and extraction agents with human review on high-risk outputs.",
    outcome:
