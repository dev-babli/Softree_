          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32 flex flex-col justify-center">
            <div className="flex flex-col items-start">
              ...
              <p className="mt-6 text-[15px] lg:text-base text-[#6B7280] leading-relaxed max-w-md">
                A structured path from use-case discovery to governed LangGraph agent systems—built for graph stability, multi-agent coordination, observability, and production-grade reliability.
              </p>
