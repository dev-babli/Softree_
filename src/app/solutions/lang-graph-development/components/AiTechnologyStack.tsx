...
export default function AiTechnologyStack() {
  ...
  return (
    <section className="bg-transparent px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
      <div className="mx-auto max-w-[85rem]">
        ...
        <div className="mb-10 flex flex-col items-center text-center">
          ...
          <h2 className="mb-2 text-center text-2xl font-extrabold leading-tight tracking-tight text-[#111827] md:mb-3 md:text-4xl lg:text-[2.25rem]">
            ...
            <span className="text-[#FF6A13]">LangGraph development</span>
          </h2>

          <p className="mx-auto mb-6 max-w-2xl text-center text-[15px] leading-relaxed text-[#6B7280] lg:mb-8 lg:text-base">
            We build production-ready LangGraph solutions using LangGraph, LangChain, LangSmith, OpenAI, Anthropic, vector stores, cloud platforms, and enterprise observability tools.
          </p>
        </div>
