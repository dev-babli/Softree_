      ...
      <div className="relative z-10 max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center w-full mb-8 lg:mb-10">
          ...
          <p className="text-[15px] lg:text-base text-[#6B7280] text-center max-w-2xl leading-snug">
            Softree LangGraph development capabilities cover stateful agent graphs, multi-agent teams, tool integrations, memory and checkpoints, RAG nodes, and continuous evaluation.
          </p>
        </div>
        ...
        >
          ...
          <div className="relative w-full lg:w-[60%] lg:min-h-[600px]">
              ...
              >
                <div className="flex min-h-0 flex-1 flex-col md:flex-row">
                  ...
                  <motion.div
                    ...
                    className={`group relative flex w-full flex-1 items-center justify-center overflow-hidden border-r border-gray-100 bg-[#0B0F19] md:w-[48%] md:flex-none ${(activeData as any).image ? '' : 'p-6'}`}
                  >
                    <div className="relative z-10 flex h-full min-h-[240px] w-full items-center justify-center sm:min-h-[280px] md:absolute md:inset-0 md:min-h-0">
                      {(activeData as any).image ? (
                        <>
                          <img
                            src={(activeData as any).image}
                            alt={activeData.title}
                            className="absolute inset-0 h-full w-full object-contain object-center p-2 sm:p-3 transition-transform duration-700 group-hover:scale-[1.02]"
                          />
                          <div className="pointer-events-none absolute inset-0 bg-gradient-to-t from-black/45 via-transparent to-transparent" />
                          <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#FF5812]/10 via-transparent to-transparent opacity-80" />
                          <div className="absolute bottom-3 left-3 right-3 z-20 sm:bottom-4 sm:left-4 sm:right-4">
                            <span className="inline-flex max-w-full truncate rounded-full border border-white/20 bg-black/45 px-3 py-1 text-[10px] font-bold uppercase tracking-[0.16em] text-white backdrop-blur-sm">
                              {activeData.title}
                            </span>
                          </div>
                        </>
                  ...
                  {/* Content Area */}
                  <div className="flex w-full min-h-0 flex-1 flex-col justify-center overflow-y-auto p-5 sm:p-6 md:w-[52%] lg:p-8">
