...
const steps = [
  ...
  },
  {
    ...
    rightCard: {
      ...
      points: [
        ...
        "Enable real-time AI actions",
        "Reduce manual data movement",
        "Create connected AI workflows",
      ],
    }
  },
  {
    ...
    rightCard: {
      ...
      points: [
        ...
        "Better access to relevant insights",
  ...
  },
  {
    step: "05",
    leftCard: {
      title: "Scale AI Across Operations",
      points: [
    ...
    rightCard: {
      ...
      points: [
        ...
        "Standardize AI-enabled processes",
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-12">
        ...
        <div className="mx-auto mb-16 max-w-5xl text-center">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-[2.25rem] font-extrabold text-gray-900 tracking-tight mb-6 max-w-5xl mx-auto leading-tight">
            Turn AI Agents into Measurable <span className="text-[#FF5812]">Business Outcomes</span>
          </h2>
          <p className="text-[15px] lg:text-base text-gray-500 max-w-3xl mx-auto leading-relaxed">
            Our AI agent development services help enterprises automate complex workflows, connect business systems, improve decision-making, and deploy secure AI agents that deliver measurable operational value.
          </p>
        </div>
