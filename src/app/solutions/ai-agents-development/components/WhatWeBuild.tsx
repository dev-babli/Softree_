...
/* ─────────────────────────────────────────────────────────────────
   CONTENT  —  KEEP AS-IS
   ───────────────────────────────────────────────────────────────── */
import { whatWeBuildData } from '../data/whatWeBuild';

const BASE_CARDS = whatWeBuildData.cards;
    ...
    >
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center my-auto px-2">
          ...
          <h3
            className="text-xl md:text-2xl font-semibold leading-snug tracking-[-0.025em] mb-3 sm:mb-4 max-w-[16ch]"
          >
            {card.title}
          </h3>
          <p
            className="text-base leading-relaxed max-w-[26ch] opacity-70"
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-5 sm:px-8 md:px-12">
        {/* Title row — matching Core Capabilities style */}
        <div className="flex flex-col items-center text-center gap-5 md:gap-6 pt-10 sm:pt-12 md:pt-14 mb-10 md:mb-14 mx-auto max-w-[800px]">
          ...
          <h2 className="text-[clamp(32px,4.5vw,56px)] font-semibold leading-[0.9] tracking-[-0.04em] text-[#0A0A1A]">
            ...
            <span className="text-[#FF5812]">
              {whatWeBuildData.heading.highlight}
            </span>
