      ...
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center max-w-4xl mx-auto mb-10 px-4">
          ...
          <h2 className="text-[clamp(32px,4.5vw,56px)] font-semibold leading-[0.9] tracking-[-0.04em] text-[#0A0A1A]">
            {technologyStackData.heading.prefix}
            <span className="text-[#FF5812]">
              {technologyStackData.heading.highlight}
            </span>
            {technologyStackData.heading.suffix}
          </h2>

          <p className="mt-6 text-base leading-relaxed text-[#0a0a1a]/70 max-w-3xl mx-auto">
            {technologyStackData.subheading}
          </p>
        </div>
        ...
        >
          ...
          >
            {[...technologyStackData.categories, ...technologyStackData.categories].map((stack, idx) => (
              <motion.div
                    ...
                    {stack.items.map((item, i) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <div
                            className={`flex items-center justify-center w-11 h-11 rounded-xl transition-all duration-500 ${stack.iconClass} group-hover/item:scale-110 group-hover/item:rotate-6`}
                          >
