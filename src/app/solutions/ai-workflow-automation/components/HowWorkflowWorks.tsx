 ...
 */
const PILL_Y_WOBBLE_PX = [-10, 22, -8, 8, -6];

/* 20 cards = 4× loops × 5 base cards → seamless infinite wrap. */
const TOTAL_CARDS = 20;
const DEG_PER_CARD = 18; // matches data-gsap-slider-rotate="18"
...
/* ─────────────────────────────────────────────────────────────────
   MAIN COMPONENT
   ───────────────────────────────────────────────────────────────── */
export default function HowWorkflowWorks() {
