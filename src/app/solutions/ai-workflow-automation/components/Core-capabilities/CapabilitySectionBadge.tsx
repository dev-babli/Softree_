...
export default function CapabilitySectionBadge({ text, variant = 'pill' }: { text: string, variant?: 'pill' | 'line' }) {
    if (variant === 'line') {
        return (
            <div className="mb-4 flex items-center justify-center gap-4 md:gap-6">
                ...
                <span className="text-[#FF5812] font-bold tracking-[0.2em] text-[11px] md:text-sm uppercase text-center whitespace-nowrap">
                    {text}
                </span>
                <div className="flex items-center relative h-[1.5px] w-10 sm:w-16 bg-[#FF5812]">
