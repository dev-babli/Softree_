...
export default function CapabilitiesBentoGrid() {
  ...
  return (
    <section className="relative w-full py-16 lg:py-20 bg-transparent overflow-hidden font-sans">
      ...
      <div className="relative z-10 max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center w-full mb-6 lg:mb-8">
          ...
          <h2 className="text-3xl md:text-4xl lg:text-[2.5rem] font-extrabold text-[#111827] mb-3 tracking-tight text-center leading-tight">
            Enterprise AI <span className="text-[#FF6B2C]">Workflow Automation Capabilities</span>
          </h2>

          <p className="text-[15px] lg:text-[17px] text-[#6B7280] text-center max-w-2xl leading-snug">
            Accelerate business operations with intelligent AI workflow automation solutions. Softree helps organizations automate repetitive processes, integrate enterprise systems, deploy AI-powered decision-making, and optimize workflows using Microsoft Power Platform, Azure AI, Copilot Studio, and enterprise-grade automation technologies.
          </p>
        </div>
