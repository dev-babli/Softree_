...
import { WorkflowSolutionsStep } from "./workflow-solutions-data";
import Check from "lucide-react/dist/esm/icons/check";

interface WorkflowSolutionsCardProps {
  step: WorkflowSolutionsStep;
  index: number;
  activeIndex: number;
  onClick: () => void;
  isLast: boolean;
...
export function WorkflowSolutionsCard({
  step,
  index,
  activeIndex,
  onClick,
  isLast,
}: WorkflowSolutionsCardProps) {
    ...
    <div className="relative flex items-stretch cursor-pointer group" onClick={onClick}>
      ...
      <div className="relative flex flex-col items-center mr-6 md:mr-10 w-16 shrink-0">
        ...
        <div className="relative z-10 flex items-center justify-center w-16 h-16 mt-2">
          {isActive && (
            <motion.div
              layoutId="workflow-solutions-active-bubble"
