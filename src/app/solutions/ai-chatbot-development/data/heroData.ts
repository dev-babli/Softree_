...
export const HERO_DATA = {
  ...
  heading: {
    prefix: "AI Chatbot Development",
    highlight: "for Enterprise Conversations",
    suffix: "",
  },
  paragraph:
    "Softree Technology designs and builds secure AI chatbots for customer support, employee self-service, and sales—grounded in your knowledge, integrated with your systems, and governed for production.",
  ctaButtons: {
    primary: {
