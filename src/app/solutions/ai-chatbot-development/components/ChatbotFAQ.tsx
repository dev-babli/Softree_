...
export default function ChatbotFAQ({ faqs: customFaqs }: ChatbotFAQProps) {
      ...
      <div className="mx-auto max-w-[1400px] px-6 md:px-12">
        <div ref={titleRef} className="mb-8 md:mb-10">
          ...
          <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-[#0a0a1a]/70">
            Common questions about Softree AI chatbot development—knowledge
            grounding, integrations, handoffs, security, and delivery.
          </p>
        </div>
