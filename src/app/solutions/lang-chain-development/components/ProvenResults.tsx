...
const provenResults = [
  {
    ...
    title: "LangChain Enterprise RAG Q&A",
    challenge:
      "Employees could not find trusted answers across scattered policy and knowledge repositories.",
    solution:
      "Built a permission-aware LangChain RAG chain with hybrid retrieval grounded in approved content and cited sources.",
    outcome:
  ...
  },
  {
    ...
    title: "LangGraph Support Agent Team",
    challenge:
      "Support agents spent too long drafting replies without access to live product knowledge and CRM context.",
    solution:
      "Deployed LangGraph agents with tool calling to help content, ticketing, and CRM systems under scoped credentials.",
  ...
  {
    category: "OPERATIONS",
    title: "LangChain Document Processing Chain",
    challenge:
      "Teams manually reviewed long contracts and operational documents.",
    solution:
      "Combined document loaders with LangChain summarization and extraction chains with human review on high-risk outputs.",
    outcome:
      "Reduced document cycle time with eval gates before production release.",
    metric: "50%",
      ...
      <div className="relative z-10 mx-auto max-w-[85rem] px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="mt-4 mb-4 text-2xl font-extrabold leading-tight tracking-tight text-[#111827] md:text-4xl lg:text-[42px]">
            Delivering Proven LangChain Development With{" "}
          ...
          <p className="mx-auto max-w-2xl text-[15px] leading-relaxed text-[#6B7280] lg:text-[17px]">
            Explore how Softree LangChain development services drive grounded
          ...
          {provenResults.map((result, idx) => {
            ...
            return (
              ...
              >
                ...
                <div
                  className={`relative flex w-[4.5rem] shrink-0 flex-col justify-end overflow-hidden rounded-[1.25rem] border border-white/10 bg-gradient-to-b p-3 text-white shadow-md sm:w-[5.5rem] sm:p-4 ${gradientBg}`}
                >
