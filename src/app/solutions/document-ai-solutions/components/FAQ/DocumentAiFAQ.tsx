...
const defaultFaqs: FAQItem[] = [
  {
    id: 1,
    serial: "question 01",
    question: "What are Document AI Solutions?",
    answer:
      "Document AI Solutions use Artificial Intelligence, OCR, and Intelligent Document Processing (IDP) to automatically capture, classify, extract, validate, and process information from invoices, contracts, forms, PDFs, emails, and other business documents. This helps organizations reduce manual work, improve accuracy, and accelerate digital transformation.",
  },
  {
    id: 2,
    serial: "question 02",
    question: "What are the benefits of implementing Document AI?",
    answer:
      "Document AI improves processing speed, eliminates manual data entry, increases accuracy, reduces operational costs, strengthens compliance, and automates document-centric workflows. Businesses also gain faster decision-making through real-time access to structured document data.",
  },
  {
    id: 3,
    serial: "question 03",
    question: "Which documents can Document AI process?",
    answer:
      "Our Document AI solutions can process invoices, purchase orders, contracts, receipts, HR documents, insurance claims, financial statements, tax forms, applications, emails, scanned PDFs, handwritten forms, and many other structured or unstructured business documents.",
  },
  {
    id: 4,
    serial: "question 04",
    question: "Which Microsoft technologies do you use for Document AI Solutions?",
    answer:
      "Softree develops Document AI Solutions using Azure AI Document Intelligence, Azure OpenAI, Microsoft AI, Power Automate, Power Apps, SharePoint, Microsoft Fabric, Dynamics 365, Microsoft 365, and enterprise integration services to build secure and scalable document automation platforms.",
  },
  {
    id: 5,
    serial: "question 05",
    question: "Can Document AI integrate with our existing business systems?",
    answer:
      "Yes. Our Document AI Solutions integrate seamlessly with SharePoint, Microsoft 365, Dynamics 365, ERP systems, CRM platforms, SQL databases, Power Platform, REST APIs, and other enterprise applications to automate end-to-end document workflows.",
  },
  {
    id: 6,
    serial: "question 06",
    question: "Is Document AI secure for enterprise organizations?",
    answer:
      "Absolutely. We implement enterprise-grade security with Microsoft Azure, role-based access control, encryption, audit logs, compliance policies, and secure data processing to protect sensitive business documents and meet regulatory requirements.",
  },
  {
    id: 7,
    serial: "question 07",
    question: "How long does it take to implement a Document AI Solution?",
    answer:
      "Implementation timelines depend on document complexity, AI model requirements, integrations, and workflow automation needs. Most projects can be delivered in phases, allowing organizations to start automating document processes quickly while scaling over time.",
  },
  {
    id: 8,
    serial: "question 08",
    question: "Why choose Softree Technology for Document AI Solutions?",
    answer:
      "Softree Technology delivers enterprise-grade Document AI Solutions using Microsoft AI, Azure AI Document Intelligence, Intelligent Document Processing (IDP), and Power Platform. Our experts build secure, scalable, and fully integrated solutions that improve document accuracy, automate workflows, reduce costs, and drive measurable business outcomes.",
  },
]
...
export function DocumentAiFAQ({ faqs: customFaqs }: DocumentAiFAQProps) {
  ...
  return (
    <section ref={sectionRef} className="relative w-full bg-transparent py-10 md:py-16">
      {/* FAQPage JSON-LD */}
      <script
