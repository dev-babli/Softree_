...
const provenResults = [
    {
        ...
        challenge:
            "Manual document processing, data entry, and paper-based workflows slow operations, increase costs, and create frequent errors.",
        solution:
            "Automate document extraction, classification, and validation using Intelligent Document Processing (IDP), OCR, and Azure AI Document Intelligence.",
        outcome:
            "Accelerate document processing, improve data accuracy, and reduce manual effort across enterprise operations.",
        metric: "95%+",
    ...
    },
    {
        ...
        challenge:
            "Organizations struggle to extract structured data from invoices, contracts, forms, PDFs, and scanned documents.",
        solution:
            "Use AI-powered OCR and Azure AI Document Intelligence to capture, validate, and process structured and unstructured document data.",
        outcome:
            "Improve processing speed, eliminate manual data entry, and deliver reliable business information.",
        metric: "80%",
    ...
    },
    {
        ...
        challenge:
            "Manual approvals, disconnected systems, and document bottlenecks delay business processes and impact productivity.",
        solution:
            "Integrate Document AI with Microsoft 365, SharePoint, Power Automate, Dynamics 365, ERP, and CRM to automate end-to-end document workflows.",
        outcome:
            "Streamline approvals, improve compliance, and increase operational efficiency with intelligent document automation.",
        metric: "70%",
...
export default function ProvenResults() {
    return (
        <section className="relative w-full py-12 md:py-16 lg:py-20 overflow-hidden font-sans bg-transparent">
            <div className="container mx-auto px-4 md:px-6 relative z-10 max-w-7xl">
                ...
                >
                    ...
                    <h2 className="text-3xl md:text-4xl lg:text-[42px] font-extrabold text-[#111827] mt-4 mb-4 tracking-tight leading-tight">
                        Document AI Solutions Built for <span className="text-[#FF5812]">Enterprise Automation</span>
                    </h2>
                    <p className="text-[16px] lg:text-[17px] text-[#6B7280] max-w-2xl mx-auto leading-relaxed">
                        Automate document-intensive processes with Softree's Document AI Solutions. We help organizations extract, classify, validate, and process business documents using Intelligent Document Processing (IDP), OCR, Azure AI Document Intelligence, and Microsoft AI technologies.
                    </p>
                </motion.div>
