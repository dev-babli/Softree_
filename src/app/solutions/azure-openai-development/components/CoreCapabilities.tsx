      ...
      <div className="relative z-10 max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center w-full mb-8 lg:mb-10">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-[2.25rem] font-extrabold text-[#111827] mb-3 tracking-tight text-center leading-tight">
            Enterprise Azure OpenAI Development{" "}
          ...
          <p className="text-[15px] lg:text-base text-[#6B7280] text-center max-w-2xl leading-snug">
            Softree Azure OpenAI development capabilities cover production GPT apps, enterprise RAG, Microsoft 365 copilots, secure Azure networking, and continuous cost and quality optimization.
          </p>
        </div>
            ...
            {coreCapabilitiesData.map((cap, idx) => {
              ...
              return (
                <div
                  ...
                  className={`
                    relative cursor-pointer rounded-xl border p-3 transition-colors duration-300 ease-out
                    ${isActive
              ...
              >
                ...
                >
                  {activeData.kpis.map((kpi, i) => (
                    <div
                      key={i}
                      className={`group/kpi flex cursor-default flex-col items-center justify-center text-center ${i !== activeData.kpis.length - 1 ? 'sm:border-r border-gray-100' : ''}`}
                    >
