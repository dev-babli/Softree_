...
const steps = [
  ...
  },
  {
    step: "02",
    leftCard: {
      title: "Ground Answers in Your Data",
      points: [
        "Azure AI Search RAG",
        "SharePoint & Fabric sources",
  ...
  },
  {
    step: "03",
    leftCard: {
      title: "Connect Microsoft Workloads",
      points: [
        "Teams and M365 copilots",
        "Dynamics & Dataverse",
        "Power Platform flows",
        "Scoped Graph and API access",
      ],
    },
    rightCard: {
      title: "Business Impact",
  ...
  },
  {
    step: "04",
    leftCard: {
      title: "Govern Cost & Risk",
      points: [
        "Entra ID and private networking",
  ...
  },
  {
    ...
    leftCard: {
      ...
      points: [
        "Reusable Azure OpenAI patterns",
      ...
      <div className="relative mx-auto max-w-[85rem] px-4 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto mb-8 max-w-5xl text-center md:mb-10">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-[2.25rem] font-extrabold text-gray-900 tracking-tight mb-6 max-w-5xl mx-auto leading-tight">
            Turn Azure OpenAI Development into Measurable{" "}
          ...
          <p className="text-[15px] lg:text-base text-gray-500 max-w-3xl mx-auto leading-relaxed">
            Softree Azure OpenAI development services help enterprises deploy secure GPT apps on Azure, ground answers with enterprise RAG, connect Microsoft workloads, and control cost and risk in production.
          </p>
        </div>
          ...
          <div className="relative z-10 flex items-center justify-between gap-2 overflow-x-auto px-1 py-2 sm:gap-0 sm:px-2 [&::-webkit-scrollbar]:hidden [-ms-overflow-style:none] [scrollbar-width:none]">
            {steps.map((item, index) => {
              ...
              return (
                ...
                >
                  <motion.div
                    className={`flex h-10 w-10 items-center justify-center rounded-full border-2 shadow-sm transition-all duration-300 sm:h-12 sm:w-12 ${
                      isActive
        ...
        >
          ...
          <button
            onClick={handlePrev}
            className="absolute left-0 top-1/2 z-20 hidden h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-gray-100 bg-white text-gray-600 shadow-lg transition-all duration-300 hover:scale-105 hover:text-[#FF6B00] focus:outline-none sm:left-1 sm:flex lg:left-2"
          ...
          <button
            onClick={handleNext}
            className="absolute right-0 top-1/2 z-20 hidden h-11 w-11 -translate-y-1/2 items-center justify-center rounded-full border border-gray-100 bg-white text-gray-600 shadow-lg transition-all duration-300 hover:scale-105 hover:text-[#FF6B00] focus:outline-none sm:right-1 sm:flex lg:right-2"
