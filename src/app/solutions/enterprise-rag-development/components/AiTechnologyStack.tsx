...
export default function AiTechnologyStack() {
  ...
  return (
    <section className="px-4 pt-8 pb-16 lg:pt-12 lg:pb-20 bg-transparent">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 text-center flex flex-col items-center">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-[2.25rem] font-extrabold text-[#111827] mb-2 md:mb-3 tracking-tight text-center leading-tight">
            Modern AI Technology Stack for Enterprise{" "}
            <span className="text-[#FF6A13]">RAG Development</span>
          </h2>

          <p className="text-[15px] lg:text-base text-[#6B7280] mb-6 lg:mb-8 text-center max-w-2xl mx-auto leading-relaxed">
            We build production-ready RAG solutions using leading LLMs, embedding models, vector databases, retrieval frameworks, Microsoft AI, and cloud technologies for secure, accurate, and scalable enterprise deployment.
          </p>
        </div>
