...
const steps = [
  {
    ...
    leftCard: {
      ...
      points: [
        "Planner, executor, and critic roles",
        "Parallel multi-agent tasking",
  ...
  },
  {
    step: "02",
    leftCard: {
      title: "Share Enterprise Context",
      points: [
        "Shared memory across agents",
        "Permission-aware RAG retrieval",
        "SharePoint and document grounding",
        "Consistent cited responses",
      ],
    },
    rightCard: {
      title: "Business Impact",
      points: [
        "Fewer contradictory agent outputs",
  ...
  },
  {
    step: "03",
    leftCard: {
      title: "Connect Systems & Tools",
      points: [
        "CRM and ERP tool calling",
        "Microsoft 365 connectivity",
        "Scoped API access per agent",
    ...
    rightCard: {
      ...
      points: [
        ...
        "Enable real-time collaborative actions",
        "Reduce manual data movement",
        "Create connected agent workflows",
      ],
    },
  },
  {
    step: "04",
    leftCard: {
      title: "Improve Collaborative Decisions",
      points: [
        "Multi-agent critique and debate",
        "Shared live business data",
        "Consensus and escalation rules",
  ...
  },
  {
    step: "05",
    leftCard: {
      title: "Scale Agent Teams Across Ops",
      points: [
        "Reusable multi-agent architectures",
        "Department-specific agent teams",
        "Role-based agent experiences",
    ...
    rightCard: {
      title: "Business Impact",
      points: [
        "Extend automation across departments",
        "Support growing workloads",
        "Standardize agentic processes",
  ...
  },
  {
    step: "06",
    leftCard: {
      title: "Operate Multi-Agent Securely",
      points: [
        "Role-based access control",
        "Enterprise authentication",
        "Per-agent monitoring and audit trails",
    ...
    rightCard: {
      ...
      points: [
        ...
        "Maintain controlled agent access",
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-12">
        ...
        <div className="mx-auto mb-16 max-w-5xl text-center">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-[2.25rem] font-extrabold text-gray-900 tracking-tight mb-6 max-w-5xl mx-auto leading-tight">
            Outcomes that compound when{" "}
            <span className="text-[#FF5812]">agents work as a team</span>
          </h2>
          <p className="text-[15px] lg:text-base text-gray-500 max-w-3xl mx-auto leading-relaxed">
            Our multi-agent systems help enterprises orchestrate specialized AI agents, connect business systems, improve collaborative decision-making, and deploy secure agent teams that deliver measurable operational value.
          </p>
        </div>
