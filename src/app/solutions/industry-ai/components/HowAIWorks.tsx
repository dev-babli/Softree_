...
export default function HowAIWorks() {
  const { workflowSteps, sections } = useIndustryConfig();
  ...
  return (
    <section className="relative w-full overflow-hidden bg-gradient-to-b from-zinc-50 via-white to-zinc-50 py-12 lg:py-16" ref={containerRef}>
      ...
      <div className="relative z-10 mx-auto flex max-w-[85rem] flex-col items-center px-4 sm:px-6 lg:px-8">
        ...
        <h2 className="mb-2 text-center text-2xl font-extrabold leading-tight tracking-tight text-[#111827] md:mb-3 md:text-4xl lg:text-[2.25rem]">
          {copy.title} <span className="text-[#FF5812]">{copy.highlight}</span>
        </h2>
        ...
        <div
          className="mb-8 flex w-full flex-col gap-4 rounded-[28px] border border-black/5 bg-white p-4 shadow-[0_20px_60px_-40px_rgba(0,0,0,0.35)] lg:flex-row lg:gap-6 lg:p-5"
