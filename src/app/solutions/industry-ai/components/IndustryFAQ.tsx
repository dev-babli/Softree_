...
export default function IndustryFAQ({ faqs: customFaqs }: IndustryFAQProps) {
  const { faqs: defaultFaqs, sections } = useIndustryConfig();
      ...
      <div className="mx-auto max-w-[85rem] px-4 sm:px-6 lg:px-8">
        <div ref={titleRef} className="mb-8 md:mb-10">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-[#1852FF]/20 bg-[#1852FF]/8 px-4 py-2">
            ...
            <span className="text-sm font-medium text-[#1852FF]">{copy.badge}</span>
          </div>
