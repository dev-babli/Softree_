...
export default function WhyChooseWithTestimonials() {
  ...
  return (
    <section className="bg-gradient-to-b from-zinc-50 via-white to-zinc-50 py-12 text-gray-900 lg:py-16">
      <div className="mx-auto grid max-w-[85rem] grid-cols-1 items-start gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:gap-16 lg:px-8">
        {/* ================= LEFT : WHY CHOOSE ================= */}
        <div className="relative">
          ...
          {/* Heading */}
          <h2 className="mb-8 text-2xl font-extrabold leading-tight md:mb-10 md:text-4xl lg:text-[2.25rem]">
            Built for{" "}
        ...
        {/* ================= RIGHT : TESTIMONIALS ================= */}
        <div className="rounded-2xl border border-white/10 bg-gradient-to-r from-black via-[#4c1c02] to-black p-6 shadow-2xl sm:p-10">
          {/* Header */}
          <div className="mb-10">
          ...
          <div className="mt-8 flex items-center gap-2 text-gray-400">
            <button
              ...
              className="inline-flex h-11 w-11 items-center justify-center rounded-full transition hover:text-white"
