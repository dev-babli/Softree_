...
export const metadata: Metadata = applyPageOg("/about-us-page1", {
  ...
  alternates: {
    canonical: "https://www.softreetechnology.com/about-us-page1",
  },
  ...
  openGraph: {
    ...
    url: "https://www.softreetechnology.com/about-us-page1",
...
export default function AboutUsPage1Layout({
  children,
}: {
