...
const slides = [
  {
    ...
    badge: "APPLICATION TESTING",
    description: "Test healthcare applications for functionality, usability, performance, and reliability.",
    highlights: [
      "Functionality & usability validation",
  ...
  {
    number: "02",
    title: "Patient & Clinical Workflows",
    badge: "WORKFLOW VALIDATION",
    description: "Validate patient journeys, clinical workflows, and healthcare processes.",
    highlights: [
  ...
  },
  {
    ...
    badge: "EHR INTEGRITY",
    description: "Test patient data, clinical workflows, system functionality, and data integrity.",
    highlights: [
  ...
  {
    number: "04",
    title: "Healthcare APIs & Integrations",
    badge: "SYSTEM INTEGRATION",
    description: "Test APIs, interoperability, data exchange, and connected healthcare systems.",
    highlights: [
      "API & HL7/FHIR testing",
  ...
  {
    number: "05",
    title: "Telehealth, Data & AI",
    badge: "DIGITAL HEALTH",
    description: "Test telehealth platforms, healthcare data, analytics, and AI-powered healthcare applications.",
    highlights: [
  ...
  },
  {
    ...
    description: "Test healthcare security, data privacy, access controls, vulnerabilities, and compliance.",
    highlights: [
      "Data privacy & HIPAA checks",
...
export default function HealthcareTestingWorkflow() {
      ...
      <div className="relative z-30 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-[2cm] flex flex-col justify-between h-full pointer-events-auto">
        ...
        <div className="max-w-3xl">
          ...
          <h2 className="typo-heading-2 text-white drop-shadow-md leading-tight mb-2">
            Healthcare Testing for Industry-Critical Applications
          </h2>
          <p className="typo-description text-white/80 max-w-2xl mb-4">
            Comprehensive testing for healthcare applications, workflows, integrations, data, AI, and security.
          </p>
          <FlowButton 
            href="/contact" 
            text="EXPLORE HEALTHCARE TESTING" 
