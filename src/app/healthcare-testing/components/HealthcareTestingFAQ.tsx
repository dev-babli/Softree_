...
interface HealthcareTestingFAQProps {
  faqs?: FAQItem[]
}
...
const defaultFaqs: FAQItem[] = [
  {
    id: 1,
    serial: "question 01",
    question: "What is healthcare software testing?",
    answer:
      "Healthcare software testing validates healthcare applications for functionality, reliability, security, performance, usability, data accuracy, and critical healthcare workflows.",
  },
  {
    id: 2,
    serial: "question 02",
    question: "What healthcare applications can Softree test?",
    answer:
      "Softree can test healthcare applications including EHR and EMR systems, patient portals, telehealth platforms, healthcare APIs, digital health applications, data platforms, and AI-powered healthcare solutions.",
  },
  {
    id: 3,
    serial: "question 03",
    question: "Do you provide EHR and EMR testing?",
    answer:
      "Yes. EHR and EMR testing can cover patient data, clinical workflows, functionality, integrations, data integrity, APIs, usability, and regression scenarios.",
  },
  {
    id: 4,
    serial: "question 04",
    question: "Can you test HL7 and FHIR integrations?",
    answer:
      "Yes. Healthcare interoperability testing can validate HL7 and FHIR integrations, APIs, healthcare data exchange, interoperability workflows, and connected healthcare systems.",
  },
  {
    id: 5,
    serial: "question 05",
    question: "Do you provide healthcare test automation?",
    answer:
      "Yes. Healthcare test automation can include functional, API, UI, regression, integration, and end-to-end testing integrated into CI/CD workflows.",
  },
  {
    id: 6,
    serial: "question 06",
    question: "How do you test healthcare application security?",
    answer:
      "Healthcare security testing covers patient data privacy, authentication, authorization, access controls, API security, vulnerability testing, security misconfigurations, and unauthorized data access.",
  },
  {
    id: 7,
    serial: "question 07",
    question: "Can you test telehealth and digital health applications?",
    answer:
      "Yes. Testing can cover patient portals, telehealth workflows, mobile applications, scheduling, virtual care workflows, integrations, usability, security, and performance.",
  },
  {
    id: 8,
    serial: "question 08",
    question: "Can you test AI-powered healthcare applications?",
    answer:
      "Yes. Testing can validate AI-powered healthcare applications for functionality, workflow behavior, reliability, security, data handling, and integration with healthcare systems.",
  },
  {
    id: 9,
    serial: "question 09",
    question: "Can Softree integrate healthcare testing into CI/CD pipelines?",
    answer:
      "Yes. Automated healthcare testing can be integrated into CI/CD pipelines to support continuous regression testing, faster validation, automated reporting, and consistent quality checks.",
  },
]
...
export default function HealthcareTestingFAQ({ faqs: customFaqs }: HealthcareTestingFAQProps) {
      ...
      <div className="mx-auto w-full max-w-[1800px] px-4 sm:px-6 lg:px-[2cm]">
        ...
        <div ref={titleRef} className="mb-10 md:mb-14">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-orange-200 bg-orange-100 px-3 py-1">
            <span className="typo-caption text-[#FF6B2C] tracking-widest uppercase">FAQ</span>
          </div>
          ...
          <p className="typo-description text-slate-600 max-w-3xl">
            Find answers to common questions about healthcare software testing, test automation, security, compliance, APIs, EHR systems, and digital healthcare applications.
          </p>
        </div>
