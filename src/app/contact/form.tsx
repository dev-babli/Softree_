...
export default function ContactPage() {
  ...
  return (
    <section className="relative min-h-screen bg-white text-gray-900 overflow-hidden">
      ...
      {/* ================= MAIN GRID ================= */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-6 lg:py-8 grid lg:grid-cols-[0.9fr_1.1fr] gap-8 items-stretch">
        {/* ================= LEFT PANEL ================= */}
        <div className="h-full flex flex-col gap-8 p-6 lg:p-7 rounded-[28px] bg-gradient-to-br from-gray-900 via-gray-800 to-black border border-white/10 shadow-xl text-white">
          {/* TOP CONTENT */}
          <div>
            <span className="inline-flex items-center gap-2 mb-4 px-4 py-1.5 text-xs font-medium rounded-full bg-white/10 border border-white/20 text-gray-200">
        ...
        {/* ================= RIGHT PANEL ================= */}
        <div className="h-full flex flex-col gap-5 p-6 lg:p-7 rounded-[28px] bg-gradient-to-bl from-gray-900 via-gray-800 to-black border border-white/10 shadow-xl text-white">
          <div>
          ...
          <form className="space-y-3">
            ...
            {/* Upload */}
            <label className="group flex flex-col items-center justify-center gap-2 cursor-pointer border-2 border-dashed border-white/20 rounded-xl p-5 bg-white/5 hover:border-cyan-400 hover:bg-white/10 transition-all">
              <input
                type="file"
                multiple
                className="hidden"
...
${form.desc}
              ...
              className="w-full mt-3 flex items-center justify-center gap-2 bg-gradient-to-r from-cyan-500 to-blue-600 hover:scale-[1.02] text-white py-3 rounded-lg font-medium transition"
            >
