...
export default function TechnologyWeWork() {
  const layer1Caps = [
    { name: "Amazon Nova 2 Sonic", logo: <Brain className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "Amazon Bedrock", logo: <CloudCheckIcon className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "Bidirectional Streaming", logo: <RefreshCw className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "Speech-to-Speech", logo: <MessageSquare className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "WebSocket", logo: <Network className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
  ];

  const layer2Caps = [
    { name: "AI Agents", logo: <Bot className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "Function Calling", logo: <Workflow className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "Agentic Workflows", logo: <Layers className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "MCP", logo: <Settings className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "Business Tools", logo: <Wrench className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
  ];

  const layer3Caps = [
    { name: "RAG", logo: <Database className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "Vector Search", logo: <Search className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "Enterprise Knowledge", logo: <FileText className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "Databases", logo: <Layers3 className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "Business Data", logo: <BarChart2 className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
  ];

  const layer4Caps = [
    { name: "FastAPI", logo: <Zap className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    ...
    { name: "Docker", logo: <Layers className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
    { name: "Kubernetes", logo: <Network className="w-5 h-5 shrink-0 text-slate-800 group-hover:text-orange-600 transition-colors" /> },
  ...
  const rightCapabilities = [
    { title: "REAL-TIME VOICE AI", borderClass: "border-[#FF6B2C]/30", textClass: "text-[#FF6B2C]", glowClass: "shadow-[0_0_15px_rgba(255,107,44,0.25)]", hoverBorder: "group-hover:border-[#FF6B2C]/60", icon: <MessageSquare className="w-6 h-6 lg:w-[26px] lg:h-[26px] text-[#FF6B2C]" strokeWidth={2} />, desc: "Build responsive speech-to-speech experiences with real-time conversational interaction." },
    { title: "TOOL & FUNCTION CALLING", borderClass: "border-[#FF6B2C]/30", textClass: "text-[#FF6B2C]", glowClass: "shadow-[0_0_15px_rgba(255,107,44,0.25)]", hoverBorder: "group-hover:border-[#FF6B2C]/60", icon: <Wrench className="w-6 h-6 lg:w-[26px] lg:h-[26px] text-[#FF6B2C]" strokeWidth={2} />, desc: "Connect voice agents to business functions, APIs, and operational tools to perform actions." },
    { title: "RAG-POWERED VOICE AGENTS", borderClass: "border-[#FF6B2C]/30", textClass: "text-[#FF6B2C]", glowClass: "shadow-[0_0_15px_rgba(255,107,44,0.25)]", hoverBorder: "group-hover:border-[#FF6B2C]/60", icon: <Database className="w-6 h-6 lg:w-[26px] lg:h-[26px] text-[#FF6B2C]" strokeWidth={2} />, desc: "Ground voice conversations in enterprise knowledge, documents, databases, and business data." },
    { title: "AGENTIC WORKFLOWS", borderClass: "border-[#FF6B2C]/30", textClass: "text-[#FF6B2C]", glowClass: "shadow-[0_0_15px_rgba(255,107,44,0.25)]", hoverBorder: "group-hover:border-[#FF6B2C]/60", icon: <Workflow className="w-6 h-6 lg:w-[26px] lg:h-[26px] text-[#FF6B2C]" strokeWidth={2} />, desc: "Enable voice agents to reason through tasks, coordinate tools, and execute multi-step workflows." },
    { title: "ENTERPRISE SYSTEM INTEGRATION", borderClass: "border-[#FF6B2C]/30", textClass: "text-[#FF6B2C]", glowClass: "shadow-[0_0_15px_rgba(255,107,44,0.25)]", hoverBorder: "group-hover:border-[#FF6B2C]/60", icon: <Network className="w-6 h-6 lg:w-[26px] lg:h-[26px] text-[#FF6B2C]" strokeWidth={2} />, desc: "Connect voice AI with CRM, ERP, databases, applications, and existing business systems." },
  ];

  const businessImpactMetrics = [
    { title: "VOICE AI", value: "Amazon Bedrock", icon: <MessageSquare className="w-5 h-5 text-orange-400" /> },
    { title: "BACKEND", value: "FastAPI • WebSocket", icon: <Zap className="w-5 h-5 text-orange-400" /> },
    { title: "FRONTEND", value: "React", icon: <Cpu className="w-5 h-5 text-orange-400" /> },
    { title: "KNOWLEDGE", value: "RAG • MCP", icon: <Database className="w-5 h-5 text-orange-400" /> },
    { title: "INFRASTRUCTURE", value: "Docker • Kubernetes • AWS", icon: <CloudCheckIcon className="w-5 h-5 text-orange-400" /> },
  ];
    ...
    <section className="w-full max-w-[1600px] mx-auto px-3 xs:px-4 sm:px-8 lg:px-12 mt-4 sm:mt-8 md:mt-12 mb-0 z-10 relative font-sans flex flex-col gap-6 sm:gap-10">
      ...
      <div className="text-center w-full max-w-4xl mx-auto flex flex-col items-center px-4">
        ...
        <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-extrabold font-['Plus_Jakarta_Sans',sans-serif] tracking-tight text-slate-900 leading-[1.1] mb-2 sm:mb-4">
          Connect Voice AI to Your Business
        </h2>
        <p className="text-sm sm:text-base text-slate-600 font-medium max-w-2xl text-center">
          Nova 2 Sonic uses Amazon Bedrock's bidirectional streaming API for real-time voice interaction and supports function calling and agentic workflows.</p>
      </div>
              ...
              <div className="relative p-3 sm:p-3.5 lg:p-3 rounded-[14px] lg:rounded-[12px] border border-orange-500/25 bg-white shadow-sm flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-2 min-h-[66px]">
                <div className="w-full sm:w-[115px] shrink-0 text-left flex sm:block items-center justify-between sm:justify-start pb-1.5 sm:pb-0 border-b sm:border-b-0 border-orange-500/15 pl-0.5">
                  <div>
                    ...
                    <span className="text-[10px] xl:text-[11px] font-black text-slate-900 tracking-tight uppercase leading-tight block">REAL-TIME VOICE</span>
                  </div>
                </div>
              ...
              <div className="relative p-3 sm:p-3.5 lg:p-3 rounded-[14px] lg:rounded-[12px] border border-orange-500/25 bg-white shadow-sm flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-2 min-h-[66px]">
                <div className="w-full sm:w-[115px] shrink-0 text-left flex sm:block items-center justify-between sm:justify-start pb-1.5 sm:pb-0 border-b sm:border-b-0 border-orange-500/15 pl-0.5">
                  <div>
                    ...
                    <span className="text-[10px] xl:text-[11px] font-black text-slate-900 tracking-tight uppercase leading-tight block">AI AGENT & ORCHESTRATION</span>
                  </div>
                </div>
                <div className="hidden sm:block w-[1px] h-9 bg-orange-500/25 self-center shrink-0" />
                <div className="grid grid-cols-3 lg:grid-cols-5 gap-1.5 sm:gap-1 pl-0 sm:pl-1 flex-1 items-start justify-center w-full">
              ...
              <div className="relative p-3 sm:p-3.5 lg:p-3 rounded-[14px] lg:rounded-[12px] border border-orange-500/25 bg-white shadow-sm flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 sm:gap-2 min-h-[66px]">
                <div className="w-full sm:w-[115px] shrink-0 text-left flex sm:block items-center justify-between sm:justify-start pb-1.5 sm:pb-0 border-b sm:border-b-0 border-orange-500/15 pl-0.5">
                  <div>
                    ...
                    <span className="text-[10px] xl:text-[11px] font-black text-slate-900 tracking-tight uppercase leading-tight block">KNOWLEDGE & DATA</span>
                  </div>
                </div>
                <div className="hidden sm:block w-[1px] h-9 bg-orange-500/25 self-center shrink-0" />
                <div className="grid grid-cols-3 lg:grid-cols-5 gap-1.5 sm:gap-1 pl-0 sm:pl-1 flex-1 items-start justify-center w-full">
            ...
            <div className="lg:col-span-2 flex items-center justify-center relative z-10 py-6 lg:py-0">
              <div className="relative flex items-center justify-center w-[150px] h-[150px] sm:w-[180px] sm:h-[180px]">
                ...
                <div className="absolute inset-4 sm:inset-5 rounded-full bg-white border-2 border-orange-400/50 shadow-[inset_0_0_20px_rgba(255,107,44,0.05),0_0_30px_rgba(255,107,44,0.15)] flex flex-col items-center justify-center gap-0.5 sm:gap-1 z-10">
                  ...
                  <span className="text-[10.5px] sm:text-[11px] lg:text-[11px] font-black tracking-widest text-slate-900 select-none text-center mt-0.5">NOVA 2</span>
                  <span className="text-[9px] sm:text-[9.5px] lg:text-[10px] font-black tracking-widest text-orange-600 select-none text-center mt-[-1px]">SONIC</span>
                  <span className="text-[7px] sm:text-[7.5px] lg:text-[7.5px] font-bold tracking-widest text-slate-500 mt-1 select-none text-center px-2 leading-tight">VOICE AI</span>
                </div>
              </div>
            </div>
      ...
      <div className="relative overflow-hidden rounded-[20px] border border-orange-500/20 bg-white py-4 px-4 sm:px-6 md:px-8 shadow-[0_10px_30px_rgba(0,0,0,0.03)] flex flex-col lg:flex-row items-center justify-between gap-5 lg:gap-6 z-10 text-slate-900 w-full">
        ...
        <div className="flex items-center gap-3 shrink-0 border-b lg:border-b-0 lg:border-r border-slate-200 pb-3 lg:pb-0 lg:pr-6 w-full lg:w-auto">
          ...
          <div className="text-left">
            <span className="text-[13px] sm:text-[14.5px] lg:text-[15px] font-black text-orange-600 tracking-wider uppercase select-none">BUILT WITH</span>
          </div>
        </div>
