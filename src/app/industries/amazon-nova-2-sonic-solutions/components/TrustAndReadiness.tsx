...
const processSteps = [
  {
    step: "01",
    title: "AWS AI TECHNOLOGY",
    body: "Amazon Bedrock\nAmazon Nova 2 Sonic"
  },
  {
    step: "02",
    title: "PRODUCTION ENGINEERING",
    body: "Cloud-native architecture\nAPI integration\nScalable infrastructure"
  },
  {
    step: "03",
    title: "ENTERPRISE AI",
  ...
  },
  {
    ...
    body: "Offshore engineering\nWhite-label delivery\nDedicated engineering support"
  },
  {
    step: "05",
    title: "TRUST SIGNALS",
    body: "ISO 27001:2022 · ISO 9001:2015\nAI & Automation · Microsoft Technologies · Modern Engineering"
  }
];

const icons = [Search, Database, Sparkles, Sliders, Cloud, Activity];

export default function TrustAndReadiness() {
  return (
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32 flex flex-col justify-center">
            <div className="flex flex-col items-start">
              <SectionBadge text="TRUST & ENTERPRISE READINESS" variant="line" />
              ...
              <h2 className="mt-4 text-3xl md:text-4xl lg:text-[2.5rem] font-extrabold text-[#111827] tracking-tight leading-tight">
                ...
                <span className="text-[#FF5812]">Not Just Demos</span>
              </h2>
              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 mt-auto">
                    ...
                    <p className="text-sm md:text-[15px] text-zinc-400 leading-relaxed font-normal whitespace-pre-line">
                      {step.body}
                    </p>
                  </div>
                </motion.div>
