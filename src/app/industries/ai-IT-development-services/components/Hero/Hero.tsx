...
export default function Hero() {
    ...
    return (
        <section
            className={`relative w-full min-h-[85vh] lg:min-h-screen overflow-hidden select-none flex items-center justify-center ${
        ...
        >
            ...
            {/* Hero Overlay */}
            <div className="relative z-10 w-full max-w-5xl mx-auto px-6 sm:px-8 lg:px-12 flex flex-col items-center text-center pointer-events-none mt-24 md:mt-20">
                <span className="font-mono text-[10px] sm:text-xs font-bold tracking-[0.25em] uppercase mb-4 sm:mb-6 px-3 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 text-[#FF5812] backdrop-blur-sm pointer-events-auto flex items-center gap-2">
                    ...
                    AI & IT DEVELOPMENT SERVICES
                </span>
                
                <h1 className={`text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold tracking-tight mb-6 leading-[1.1] ${isDarkMode ? 'text-white' : 'text-slate-900'}`}>
                ...
                <p className={`text-base sm:text-lg md:text-xl max-w-2xl mb-8 md:mb-12 leading-relaxed ${isDarkMode ? 'text-slate-200' : 'text-slate-600'}`}>
                    AI-powered software development and IT solutions designed to help businesses innovate, automate, and scale.
                </p>
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full sm:w-auto pointer-events-auto">
                    ...
                    <Button asChild variant="outline" size="lg" className="h-12 px-8 text-base font-semibold bg-white/50 dark:bg-black/50 backdrop-blur-sm hover:bg-slate-100 dark:hover:bg-gray-900 border-white/20 hover:border-white/40 text-slate-900 dark:text-white">
                        <Link href="/contact">
                            Talk to Our Experts
                        </Link>
                    </Button>
