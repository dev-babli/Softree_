...
onMounted(() => {
  ...
  function generateRandomChars(text, chars) {
    let result = ''
  ...
  function runScramble(layout, config) {
  ...
  ctx = gsap.context(() => {
    ...
    soloElements.forEach((el) => {
      ...
      if (config.trigger === 'scroll') {
        ...
        const fn = () => runScramble(layout, config)
        ...
        el.scrambleTrigger = () => runScramble(layout, config)
      }
    })
  ...
  hoverListeners._onResize = onResize
})
...
onUnmounted(() => {
  ...
  if (hoverListeners._onResize) window.removeEventListener('resize', hoverListeners._onResize)
  clearTimeout(resizeTimeout)
})
</script>

<template>
  <div ref="containerRef" class="dual_scramble_wrap">

    <div
      class="dual_scramble_hero"
      data-anm-dual-scramble-group
      data-anm-trigger="scroll"
      data-anm-stagger="0.15"
      data-anm-start="top 80%"
    >
      <span class="dual_scramble_eyebrow">Kinetic Athletics</span>
      <h1
        class="dual_scramble_headline"
    ...
    <nav class="dual_scramble_nav">
      <span class="dual_scramble_nav_label">Hover</span>
      <div class="dual_scramble_nav_links">
        <span class="dual_scramble_nav_link" data-anm-dual-scramble data-anm-trigger="hover" data-anm-duration="0.5">Running</span>
        <span class="dual_scramble_nav_link" data-anm-dual-scramble data-anm-trigger="hover" data-anm-duration="0.5">Cycling</span>
        <span class="dual_scramble_nav_link" data-anm-dual-scramble data-anm-trigger="hover" data-anm-duration="0.5">Training</span>
        <span class="dual_scramble_nav_link" data-anm-dual-scramble data-anm-trigger="hover" data-anm-duration="0.5">Apparel</span>
      </div>
    </nav>

    <div class="dual_scramble_stats">
      <span class="dual_scramble_stats_label">Click</span>
      <div class="dual_scramble_stats_grid">
        <div class="dual_scramble_stat">
          <span class="dual_scramble_stat_value" data-anm-dual-scramble data-anm-trigger="click" data-anm-duration="0.5">42.2KM</span>
          <span class="dual_scramble_stat_key">Distance</span>
        </div>
        <div class="dual_scramble_stat">
          <span class="dual_scramble_stat_value" data-anm-dual-scramble data-anm-trigger="click" data-anm-duration="0.5">04:12</span>
          <span class="dual_scramble_stat_key">Pace / km</span>
        </div>
        <div class="dual_scramble_stat">
          <span class="dual_scramble_stat_value" data-anm-dual-scramble data-anm-trigger="click" data-anm-duration="0.5">158BPM</span>
          <span class="dual_scramble_stat_key">Heart rate</span>
        </div>
      </div>
    </div>
