...
const whyChoose = [
  {
    ...
    desc: "Experienced AI & software engineers providing dedicated long-term support for your medical AI projects.",
  },
  {
    icon: Tag,
    title: "Flexible Engagement",
    desc: "Choose between project-based development, team augmentation, or AI consulting & POCs.",
  },
  {
    icon: Expand,
    title: "End-to-End Development",
    desc: "Faster delivery of custom-built healthcare solutions with a complete AI development lifecycle.",
  },
  {
    icon: BrainCircuit,
    title: "Scalable Architecture",
    desc: "Secure, cost-effective development built on scalable healthcare cloud architectures.",
  },
  {
    icon: UserPlus,
    title: "Seamless Integration",
    desc: "Integrate custom AI seamlessly with your existing EHRs, APIs, and healthcare systems.",
  },
  {
    icon: Globe,
    title: "Post-Launch Support",
    desc: "Ongoing monitoring, maintenance, and optimization for all your AI applications.",
  },
];
    ...
    <section className="text-gray-900 py-12 md:py-16 lg:py-20 font-sans">
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-[2cm] grid grid-cols-1 lg:grid-cols-2 gap-16 lg:items-stretch items-start">
        ...
        <div className="relative">
          ...
          {/* Heading */}
          <h2 className="text-3xl md:text-5xl font-extrabold font-['Plus_Jakarta_Sans',sans-serif] text-slate-900 leading-tight mb-6 tracking-tight">
            Built for{" "}
