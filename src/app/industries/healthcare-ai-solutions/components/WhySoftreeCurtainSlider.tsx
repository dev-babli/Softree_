...
const tabsData: TabData[] = [
  {
    ...
    title: "Discover",
    phase: "01 — DISCOVER",
    subtitle: "Understand Clinical Problem, Patient Data & Medical AI Opportunity",
    desc: "Understand the healthcare problem, patient data readiness, and clinical AI opportunity.",
    src: "/images/ai-development-service/agenticAi-1.png",
    alt: "01 Discover - Understand Healthcare Problem and AI Opportunity",
    tags: ["Clinical Discovery", "Data Readiness", "Opportunity Sizing"],
    heading: "Hospital Problem Understanding & Medical AI Mapping",
    subheading: "Audit legacy EHRs, evaluate patient data readiness, and quantify clinical ROI before engineering.",
    capabilities: [
  ...
  },
  {
    ...
    title: "Design",
    phase: "02 — DESIGN",
    subtitle: "Clinical AI Architecture, Agent Workflows & Medical Governance",
    desc: "Define the HIPAA-compliant architecture, clinical agent workflows, and medical governance.",
    src: "/images/ai-development-service/agenticAi-2.png",
    alt: "02 Design - Clinical AI Architecture and Workflows",
    tags: ["Medical AI Architecture", "Clinical Workflows", "HIPAA Governance"],
    heading: "Health System Architecture & Medical Agent Design",
    subheading: "Design secure multi-agent state machines, FHIR integration points, and patient data guardrails.",
    capabilities: [
  ...
  },
  {
    ...
    title: "Build",
    phase: "03 — BUILD",
    subtitle: "Develop Medical Agents, EHR Integrations & Automation",
    desc: "Develop the clinical agents, healthtech applications, medical RAG, and automation.",
    src: "/images/ai-development-service/agenticAi-3.png",
    alt: "03 Build - Develop Medical Agents and Integrations",
    tags: ["Clinical Agents", "Medical RAG", "Hospital Automation"],
    heading: "Engineering Medical Agents & Healthcare RAG",
    subheading: "Develop robust clinical agents, secure patient vector retrieval pipelines, and EHR connectors.",
    capabilities: [
  ...
  },
  {
    ...
    title: "Validate",
    phase: "04 — VALIDATE",
    subtitle: "Clinical Quality, Reliability, HIPAA Security & AI Behavior",
    desc: "Test diagnostic quality, reliability, HIPAA security, performance, and clinical behavior.",
    src: "/images/ai-development-service/agenticAi-4.png",
    alt: "04 Validate - Test Clinical Quality and Security",
    tags: ["Diagnostic Testing", "HIPAA Red-Teaming", "Clinical SLAs"],
    heading: "Rigorous Clinical Evaluations & Patient Safety Testing",
    subheading: "Stress-test diagnostic accuracy, evaluate medical drift, and audit security for PHI leakage.",
    capabilities: [
  ...
  },
  {
    ...
    title: "Deploy",
    phase: "05 — DEPLOY",
    subtitle: "Validated Medical AI Solutions into Hospital Environments",
    desc: "Move validated clinical AI solutions into secure hospital production environments.",
    src: "/images/ai-development-service/agenticAi-5.png",
    alt: "05 Deploy - Move Medical AI Solutions into Production",
    tags: ["HIPAA Container Deploy", "Hospital VPC", "Phased Rollout"],
    heading: "Zero-Downtime Hospital Production Deployment",
    subheading: "Ship validated medical models and agent clusters into isolated health cloud VPCs.",
    capabilities: [
  ...
  },
  {
    ...
    title: "Scale",
    phase: "06 — SCALE",
    subtitle: "Clinical Capabilities, Users, Workflows & Medical Engineering Capacity",
    desc: "Expand medical capabilities, clinical users, workflows, and healthtech engineering capacity.",
    src: "/images/ai-development-service/agenticAi-6.png",
    alt: "06 Scale - Expand Clinical Capabilities and Workflows",
    tags: ["Hospital Expansion", "Multi-Clinic", "Continuous Learning"],
    heading: "Elastic Health System Scaling & Continuous Growth",
    subheading: "Expand clinical agent concurrency, onboard new hospital departments, and optimize medical models.",
    capabilities: [
...
export default function WhySoftreeCurtainSlider() {
  ...
  return (
    <section className="pt-6 pb-12 md:pt-10 md:pb-16 lg:pt-12 lg:pb-24 font-sans relative bg-white">
      ...
      <div className="w-full max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-[2cm] flex flex-col items-start text-left mb-8 md:mb-12">
        <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-orange-200 bg-orange-50 text-[10px] sm:text-[11px] font-bold tracking-widest text-[#FF6B00] uppercase mb-4">
          ...
          FROM MEDICAL AI IDEA TO CLINICAL PRODUCTION
        </div>
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold tracking-tight mb-3 md:mb-4 text-slate-900 leading-[1.2] md:leading-[1.15]">
          Build Medical AI With a <span className="text-[#FF5812]">Clear Path to Clinical Deployment</span>
        </h2>
        <p className="text-sm sm:text-base md:text-lg text-slate-600 font-normal max-w-3xl leading-relaxed">
          Our disciplined, engineering-first delivery lifecycle moves healthcare AI from initial opportunity discovery and secure architectural design to validated clinical deployment and hospital-wide scale.
        </p>
      </div>
