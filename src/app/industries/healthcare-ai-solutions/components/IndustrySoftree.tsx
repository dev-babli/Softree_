...
export default function IndustrySoftree() {
  ...
  return (
    ...
    >
      <div className="relative mx-auto w-full max-w-[1800px] px-4 sm:px-6 lg:px-[2cm]">
        <div className="grid gap-8 lg:grid-cols-[minmax(280px,320px)_minmax(0,1fr)] xl:gap-10">
          ...
          >
            <div className="space-y-4">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-orange-200 bg-orange-50 text-[10px] sm:text-[11px] font-bold tracking-widest text-[#FF6B00] uppercase mb-2">
