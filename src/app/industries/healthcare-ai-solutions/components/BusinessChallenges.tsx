    ...
    <section className="relative w-full py-20 lg:py-28 overflow-hidden bg-transparent">
      ...
      <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 flex flex-col items-center">
        ...
        <h2 className="text-2xl md:text-4xl lg:text-[2.25rem] font-extrabold text-[#111827] mb-2 md:mb-3 tracking-tight text-center leading-tight">
          Solving Business Challenges <span className="text-[#FF5812]">With Enterprise AI</span>
        </h2>

        <p className="text-[15px] lg:text-base text-[#6B7280] mb-6 lg:mb-8 text-center max-w-2xl mx-auto leading-relaxed">
          Softree helps enterprises eliminate operational bottlenecks, automate complex workflows, modernize decision-making, and unlock greater value from their data with secure, scalable AI solutions.
        </p>
