...
export default function TechnologyWeWork() {
  ...
  const businessImpactMetrics = [
    { title: "Clinical Efficiency", value: "Automate Workflows", icon: <Zap className="w-5 h-5 text-orange-400" /> },
    { title: "Interoperability", value: "Secure FHIR APIs", icon: <RefreshCw className="w-5 h-5 text-orange-400" /> },
    { title: "Data Security", value: "HIPAA Compliant", icon: <ShieldCheck className="w-5 h-5 text-orange-400" /> },
    { title: "Patient Care", value: "AI-Driven Insights", icon: <Target className="w-5 h-5 text-orange-400" /> },
    { title: "Enterprise Scale", value: "Cloud Native", icon: <CloudCheckIcon className="w-5 h-5 text-orange-400" /> },
  ];
