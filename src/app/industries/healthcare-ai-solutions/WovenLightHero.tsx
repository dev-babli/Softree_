...
const trustItems = [
  { icon: Shield, title: 'AGENTIC AI', subtitle: 'Intelligent systems.' },
  { icon: Users, title: 'AI AGENTS & COPILOTS', subtitle: 'Context-aware assistants.' },
  { icon: Cpu, title: 'RAG', subtitle: 'Enterprise knowledge.' },
  { icon: Sparkles, title: 'INTELLIGENT AUTOMATION', subtitle: 'Streamlined workflows.' },
  { icon: Calendar, title: 'MICROSOFT & AWS AI', subtitle: 'Multi-cloud expertise.' },
];
...
export const WovenLightHero = () => {
  ...
  const headline = "Build AI. Scale Faster.";
