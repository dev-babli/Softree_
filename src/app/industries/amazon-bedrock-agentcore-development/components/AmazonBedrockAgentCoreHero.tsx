    ...
    <section className="relative w-full min-h-[100svh] overflow-hidden bg-black flex flex-col justify-center pt-[90px] md:pt-[70px] pb-10">
      ...
      <div className="relative z-10 w-full max-w-[1800px] mx-auto px-4 sm:px-6 lg:px-[2cm] flex flex-col items-center text-center">
        ...
        >
          ...
          <span className="typo-caption text-[#FF6B2C] uppercase break-words">
        ...
        <motion.h1
          ...
          className="typo-title text-white max-w-6xl mx-auto mb-4 sm:mb-6"
        >
        ...
        >
          ...
          <div className="pt-4 sm:pt-6">
            <FlowButton
              ...
              className="typo-button-lg shadow-[0_0_20px_rgba(255,107,44,0.3)] hover:shadow-[0_0_30px_rgba(255,107,44,0.5)] transform hover:-translate-y-1"
            />
          </div>
        </motion.div>
