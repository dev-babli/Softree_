...
const whyChoose = [
  {
    icon: Users,
    title: "Offshore Healthcare Testing Partner",
    desc: "Extend your engineering organization with an offshore healthcare testing team.",
  },
  {
    icon: Bot,
    title: "Healthcare + Automation Expertise",
    desc: "Combine healthcare testing expertise with automated quality engineering.",
  },
  {
    icon: ShieldCheck,
    title: "Security & Compliance Focus",
    desc: "Protect patient data with security, privacy, access control, and compliance testing.",
  },
  {
    icon: Database,
    title: "Healthcare Technology Experience",
    desc: "EHR, EMR, HL7, FHIR, APIs, digital health, data, and healthcare applications.",
  },
  {
    icon: Search,
    title: "End-to-End Testing Capability",
    desc: "Test healthcare applications across functional, API, integration, security, performance, and regression scenarios.",
  },
  {
    icon: Expand,
    title: "White-Label Friendly",
    desc: "Support technology partners and consulting firms behind their brand.",
  },
];
...
export default function WhySoftreeHealthcareTesting() {
