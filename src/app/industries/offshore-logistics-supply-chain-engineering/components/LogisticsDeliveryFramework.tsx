...
const logisticsPhases = [
  {
    number: "01",
    title: "DISCOVER",
    description: "We understand your logistics workflows, operational challenges, existing technology landscape, and business goals. We identify high-value opportunities across transportation, warehouse operations, inventory, documentation, and supply chain workflows.",
  },
  {
    number: "02",
    title: "ARCHITECT",
    description: "We design a scalable solution architecture across AI, automation, applications, data, cloud infrastructure, APIs, and enterprise systems such as ERP, TMS, WMS, and CRM.",
  },
  {
    number: "03",
    title: "BUILD",
    description: "Our offshore engineering team develops the required applications, AI solutions, automation workflows, integrations, dashboards, and intelligent systems using modern engineering practices.",
  },
  {
    number: "04",
    title: "INTEGRATE",
    description: "We connect the solution with your existing logistics ecosystem, including ERP, TMS, WMS, CRM, databases, APIs, documents, and other enterprise systems.",
  },
  {
    number: "05",
    title: "TEST & VALIDATE",
    description: "We validate functionality, integrations, security, performance, data accuracy, and workflow reliability before production deployment.",
  },
  {
    number: "06",
    title: "DEPLOY",
    description: "We deploy production-ready logistics technology through secure cloud and enterprise environments with the required monitoring, governance, and operational controls.",
  },
  {
    number: "07",
    title: "SCALE & OPTIMIZE",
    description: "After deployment, our offshore engineering team continues to improve the solution, optimize workflows, add capabilities, integrate new systems, and scale engineering capacity as your business grows.",
  },
];
...
function PhaseIcon({ number }: { number: string }) {
  if (number === "01") {
    return (
      <svg className="h-full w-full" viewBox="0 0 48 48" fill="none" stroke="currentColor">
        <defs>
          <linearGradient id="grad-p1-logistics" x1="0%" y1="0%" x2="100%" y2="100%">
        ...
        <circle cx="24" cy="24" r="7" fill="url(#grad-p1-logistics)" strokeWidth="1.2" />
  ...
  if (number === "02") {
    return (
      <svg className="h-full w-full" viewBox="0 0 48 48" fill="none" stroke="currentColor">
        <defs>
          <linearGradient id="grad-p2-logistics" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="currentColor" stopOpacity="0.6" />
            <stop offset="100%" stopColor="currentColor" stopOpacity="0.05" />
          </linearGradient>
        </defs>
        <path d="M10 12c0-2.8 6.3-5 14-5s14 2.2 14 5-6.3 5-14 5-14-2.2-14-5z" fill="url(#grad-p2-logistics)" strokeWidth="1.2" />
  ...
  if (number === "03") {
    return (
      <svg className="h-full w-full" viewBox="0 0 48 48" fill="none" stroke="currentColor">
        <defs>
          <radialGradient id="grad-p3-logistics" cx="50%" cy="50%" r="50%">
            <stop offset="0%" stopColor="currentColor" stopOpacity="0.8" />
            <stop offset="100%" stopColor="currentColor" stopOpacity="0" />
          </radialGradient>
        </defs>
        <rect x="18" y="18" width="12" height="12" rx="3" strokeWidth="1.5" />
        <circle cx="24" cy="24" r="5" fill="url(#grad-p3-logistics)" strokeWidth="1" />
...
export default function LogisticsDeliveryFramework() {
  const items = logisticsPhases.map((phase, i) => ({
    id: phase.number,
    title: phase.title,
