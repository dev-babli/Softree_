        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6 lg:px-20 flex flex-col md:flex-row items-center gap-12">
          ...
          <div className="flex-1 max-w-xl text-center md:text-left">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-light leading-tight mb-6 text-white/90">
              Unlock <span className="text-green-500">Actionable Insights</span>{" "}
              with Power BI
            </h1>

            <p className="text-base md:text-lg lg:text-xl text-white/70 mb-6">
              Transform your data into intelligent decisions. Our Power BI
              services deliver interactive dashboards, real-time reporting, and
              predictive analytics to help your business optimize performance
              and strategy.
            </p>
          ...
          <div className="flex-1 flex justify-center md:justify-end relative">
            <div className="relative w-full md:w-[600px] rounded-3xl overflow-hidden shadow-2xl border border-gray-700">
              <img
                src="/images/power-bi/hero-dashboard.png"
                alt="Power BI Dashboard Hero"
        ...
        >
          ...
          <div>
            <p className="text-white/70 text-base md:text-lg mb-2">
              Softree helped us build interactive Power BI dashboards that
              provide real-time insights across finance, operations, and
              marketing. Now our team makes faster, smarter, data-driven
              decisions.
            </p>
