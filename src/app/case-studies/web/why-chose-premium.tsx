...
import { Star, ChevronLeft, ChevronRight, Pause, Play, User, MapPin } from "lucide-react"
...
const whyChoose = [
  {
    ...
    desc: "Rapid iterations and modern delivery practices with continuous integration.",
  },
  {
    icon: <UsersIcon />,
              ...
              <div className="relative rounded-[calc(1.5rem-0.25rem)] bg-[#0a0a1a]/80 p-8 backdrop-blur-xl shadow-[inset_0_1px_1px_rgba(255,255,255,0.1)]">
                ...
                <div className="flex items-center gap-4 mb-6">
                  <div className="flex gap-1">
                    {[...Array(5)].map((_, i) => (
                      <Star key={i} className="w-4 h-4 fill-[#C86E4B] text-[#C86E4B]" />
                    ))}
                  </div>
                ...
                <p className="text-sm text-white/40 mb-8">
                  Based on <span className="font-medium text-white">150+ client reviews</span>
                </p>
                  ...
                  {reviews.map((_, i) => (
                    <button
                      ...
                      className={`h-1 rounded-full transition-all duration-300 ${
                        i === index ? "w-8 bg-[#1852FF]" : "w-2 bg-white/20"
                      }`}
                    />
                  ))}
                </div>
