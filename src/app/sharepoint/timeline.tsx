      ...
      <div ref={containerRef} className="relative w-full md:px-10">
        ...
        <div className="max-w-7xl mx-auto py-24 px-4 text-center">
          <h2 className="text-3xl md:text-5xl font-bold text-white mb-6">
            SharePoint-Driven Digital Transformation
          </h2>
          <p className="text-gray-400 text-sm md:text-base max-w-3xl mx-auto">
            Exploring Softree’s journey in building secure, scalable SharePoint
            and Microsoft 365 solutions that empower modern enterprise
