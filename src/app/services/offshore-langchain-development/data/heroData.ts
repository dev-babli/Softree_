...
export const HERO_DATA = {
  label: "OFFSHORE LANGCHAIN DEVELOPMENT",
  heading: {
    prefix: "Scalable LangChain Development Delivered by",
    highlight: "Offshore AI Experts",
    suffix: "",
  },
  paragraph:
    "Accelerate your AI roadmap. Leverage our dedicated LangChain engineers to design and deploy sophisticated LLM applications for your clients seamlessly.",
  ctaButtons: {
    primary: {
