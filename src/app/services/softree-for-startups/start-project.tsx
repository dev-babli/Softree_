        ...
        >
          ...
          <div>
            ...
            <p className="mt-4 text-sm text-white/80 max-w-lg">
              Turn your idea into a scalable digital product with Softree. We
              design, build, and launch MVPs, SaaS platforms, and web apps
              quickly — helping startups validate, grow, and scale with
              confidence.
            </p>
