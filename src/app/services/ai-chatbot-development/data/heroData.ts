...
export const HERO_DATA = {
  label: "OFFSHORE AI CHATBOT DEVELOPMENT",
  heading: {
    prefix: "High-Quality AI Chatbot Development by",
    highlight: "Dedicated Offshore Teams",
    suffix: "",
  },
  paragraph:
    "Accelerate delivery with our expert AI engineers. We build custom, context-aware AI chatbots and virtual assistants as your trusted engineering partner.",
  ctaButtons: {
    primary: {
