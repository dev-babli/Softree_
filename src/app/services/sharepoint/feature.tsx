...
export default function SharePointFeaturesAdvanced() {
  ...
  return (
    <section className="relative bg-black py-28 overflow-hidden">
      ...
      <div className="relative mx-auto max-w-7xl w-[86%]">
        ...
        <div className="text-center max-w-3xl mx-auto mb-20">
          ...
          <p className="mt-6 text-gray-400 text-lg">
            A modern collaboration platform designed for secure, scalable,
            and intelligent digital workplaces.
          </p>
        </div>
      ...
      {/* LEFT – Tabs */}
<div className="relative lg:col-span-4 p-8 
          ...
          <div className="lg:col-span-8 p-10 lg:p-14 border-t lg:border-t-0 lg:border-l border-white/10">
            ...
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <div className="mt-12 relative w-full min-h-[300px] lg:min-h-[380px] rounded-2xl bg-gradient-to-br from-white/5 to-white/0 border border-white/10 overflow-hidden">
                  <Image
