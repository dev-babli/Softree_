...
export default function SharePointHero() {
  ...
  return (
    ...
    "
        >
          Build <span className="text-blue-400">Intelligent</span> SharePoint
          Solutions
    ...
    "
        >
          ...
          <span className="text-white font-semibold">collaboration-driven</span>{" "}
          SharePoint solutions using SharePoint Online, SPFx, and Microsoft 365
          — empowering teams with intranets, document management, workflows, and{" "}
