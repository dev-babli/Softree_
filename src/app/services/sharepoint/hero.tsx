...
export default function HeroWithTestimonial() {
  ...
  const testimonials = [
    {
      text: "They streamlined our document management and automated approvals using SharePoint workflows.",
      name: "Rohit Verma",
      role: "Operations Manager",
      avatar: "https://i.pravatar.cc/100?img=11",
    },
    {
      text: "Our new SharePoint intranet improved collaboration and reduced manual work significantly.",
      name: "Sneha Patel",
      role: "IT Lead",
      avatar: "https://i.pravatar.cc/100?img=5",
    },
    {
      text: "The SPFx solutions they delivered are fast, secure, and easy for our teams to use.",
      name: "Aarav Mehta",
      role: "Startup Founder",
      avatar: "https://i.pravatar.cc/100?img=15",
    },
    {
      text: "Seamless integration with Microsoft 365 tools made our processes completely digital.",
      name: "Neha Sharma",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 lg:py-20 min-h-[70vh] grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <h1 className="text-4xl lg:text-5xl xl:text-6xl font-semibold leading-tight">
            Smart & Secure
            <br />
            <span className="text-white/90">SharePoint Solutions</span>
          </h1>

          <p className="mt-5 text-white/80 max-w-xl text-lg">
            We design and develop modern SharePoint intranets, document
            management systems and custom SPFx solutions that enhance
            collaboration, automate workflows and boost productivity across
            your organization.
          </p>
