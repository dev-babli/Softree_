...
export default function HeroWithTestimonial() {
  /* ================= TESTIMONIAL DATA (SHAREPOINT) ================= */
  const testimonials = [
    {
      text: "Their SharePoint solutions automated our internal processes and improved collaboration across teams.",
      name: "Sneha Patel",
      role: "IT Manager",
      avatar: "https://i.pravatar.cc/100?img=5",
    },
    {
      text: "Custom SPFx web parts and workflows helped us digitize operations faster than expected.",
      name: "Aarav Mehta",
      role: "Operations Head",
      avatar: "https://i.pravatar.cc/100?img=15",
    },
    {
      text: "Seamless Microsoft 365 and SharePoint integration made our document management effortless.",
      name: "Neha Sharma",
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-14 lg:py-16 min-h-[65vh] grid lg:grid-cols-2 gap-14 items-start">
        ...
        <div className="w-full space-y-7">
          ...
          <p className="text-zinc-300 text-lg leading-relaxed max-w-xl">
            We design and develop secure, scalable and modern SharePoint
            solutions including SPFx web parts, intranet portals, workflow
            automation, document management systems and seamless Microsoft 365
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            ...
            <Link href="/services/sharepoint-development">
        ...
        <div className="w-full flex flex-col gap-10">
          ...
          {/* ---------- Stats Cards (SHAREPOINT) ---------- */}
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              {
                value: "150+",
                label: "SPFx Solutions",
                icon: Rocket,
                color: "text-cyan-300",
