...
const whyChoose = [
  {
    icon: Users,
    title: "Offshore Power Platform Engineering Teams",
    desc: "Access experienced offshore Power Platform engineers and dedicated development teams that support your projects and work as an extension of your team.",
  },

  {
    icon: Tag,
    title: "White-Label Power Platform Delivery",
    desc: "Deliver Microsoft Power Platform solutions under your brand while Softree supports development, QA, integration, and delivery behind the scenes.",
  },

  {
    icon: Expand,
    title: "Flexible & Scalable Engagements",
    desc: "Scale your Power Platform development capacity through dedicated teams, project-based delivery, or flexible offshore resources.",
  },

  {
    icon: BrainCircuit,
    title: "AI, Microsoft & Modern Engineering Expertise",
    desc: "Build and modernize solutions across Microsoft Power Platform, Azure, SharePoint, data, cloud, integrations, and modern application technologies.",
  },

  {
    icon: UserPlus,
    title: "Your Team, Extended",
    desc: "Work with Softree as an extension of your team across Power Platform development, integration, modernization, and ongoing support.",
  },

  {
    icon: Globe,
    title: "Global Offshore Delivery",
    desc: "Extend your delivery capacity with India-based engineering teams supporting international clients and technology partners.",
  },
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:items-stretch items-start">
        ...
        <div className="relative">
          ...
          <div className="text-orange-600 text-xs uppercase tracking-[0.15em] mb-3">
            Why Choose Softree for Power Platform Development?
          </div>

          {/* Heading */}
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold leading-tight mb-6 whitespace-nowrap">
            Built for{" "}
