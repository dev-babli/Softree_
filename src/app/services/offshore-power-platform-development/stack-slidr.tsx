        ...
        <div className="relative w-full h-[500px]">
          {items.map((item, index) => {
            ...
            return (
              <div
                key={index}
                className="absolute top-0 left-0 w-full h-[440px]
  rounded-3xl overflow-hidden transition-all duration-700 shadow-2xl"
                style={{
                  transform: `translateY(${offset * 30}px) scale(${1 - Math.abs(offset) * 0.04})`,
