...
export default function HeroWithTestimonial() {
  /* ================= TESTIMONIAL DATA (SPFx) ================= */
  const testimonials = [
    {
      text: "Their SPFx web parts transformed our SharePoint intranet with a modern and responsive UI.",
      name: "Sneha Patel",
      role: "IT Manager",
      avatar: "https://i.pravatar.cc/100?img=5",
    },
    {
      text: "Custom extensions, automation and seamless Microsoft 365 integrations boosted our team productivity.",
      name: "Aarav Mehta",
      role: "Operations Head",
      avatar: "https://i.pravatar.cc/100?img=15",
    },
    {
      text: "From portals to dashboards, their SharePoint Framework solutions scaled perfectly for our enterprise.",
      name: "Neha Sharma",
        ...
        <div className="w-full space-y-7">
          <h1 className="text-4xl lg:text-5xl xl:text-5xl font-semibold leading-tight tracking-tight">
            ...
            <span className="bg-gradient-to-r from-sky-400 via-cyan-300 to-teal-300 bg-clip-text text-transparent">
              SPFx Solutions for SharePoint
            </span>
          </h1>

          <p className="text-zinc-300 text-lg leading-relaxed max-w-xl">
            We develop modern SharePoint Framework (SPFx) solutions including
            custom web parts, extensions, intranet portals, dashboards and
            Microsoft 365 integrations that enhance collaboration, automate
            workflows and deliver powerful digital workplace experiences.
          </p>
