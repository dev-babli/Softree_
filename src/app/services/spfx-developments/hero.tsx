...
const testimonials = [
  {
    text: "Softree delivered high-performance SPFx web parts that seamlessly integrated with our SharePoint Online environment.",
    name: "Priya Nair",
    role: "IT Manager, Enterprise Organization",
  },
  {
    text: "Their SPFx expertise helped us modernize our intranet with reusable components and deep Microsoft 365 integration.",
    name: "Rohit Sharma",
    role: "Digital Transformation Lead",
  },
  {
    text: "From SPFx extensions to custom web parts, the implementation was clean, scalable, and future-ready.",
    name: "Ankit Verma",
    ...
    <section className="relative bg-[#00091A] pt-24 pb-24 overflow-hidden">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 text-center mt-4">
        ...
        <h1
          ...
          "
        >
          Build <span className="text-blue-400">Scalable</span> SPFx Solutions
        ...
        >
          ...
          using SharePoint Framework, React, and Microsoft Graph — enabling rich
          user experiences, seamless Microsoft 365 integration, and{" "}
          <span className="text-white font-semibold">
            enterprise-grade SharePoint solutions
          </span>
          .
        </p>
