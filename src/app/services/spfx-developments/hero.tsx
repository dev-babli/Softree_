...
export default function HeroWithTestimonial() {
  ...
  const testimonials = [
    {
      text: "Their SPFx web parts modernized our intranet and significantly improved user experience.",
      name: "Rohit Verma",
      role: "IT Manager",
      avatar: "https://i.pravatar.cc/100?img=11",
    },
    {
      text: "Custom SharePoint extensions automated our workflows and saved hours of manual work daily.",
      name: "Sneha Patel",
      role: "Operations Lead",
      avatar: "https://i.pravatar.cc/100?img=5",
    },
    {
      text: "Fast, scalable React-based SPFx solutions perfectly matched our enterprise needs.",
      name: "Aarav Mehta",
      role: "Startup Founder",
      avatar: "https://i.pravatar.cc/100?img=15",
    },
    {
      text: "Our intranet now feels like a modern web app thanks to their SharePoint customization expertise.",
      name: "Neha Sharma",
  ...
  return (
    <section className="relative overflow-hidden text-white bg-gradient-to-br from-[#0b3ea8] via-[#1557c0] to-[#1e73d8]">
      ...
      {/* SAME LAYOUT (compact + professional) */}
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-16 lg:py-20 min-h-[70vh] grid lg:grid-cols-2 gap-10 items-center">
        ...
        <div>
          ...
          <h1 className="text-4xl lg:text-5xl xl:text-6xl font-semibold leading-tight">
            Custom SharePoint
            <br />
            <span className="text-white/90">SPFx Solutions</span>
          </h1>

          <p className="mt-5 text-white/80 max-w-xl text-lg">
            We build modern SharePoint Framework web parts, extensions and
            intranet solutions using React and TypeScript — delivering fast,
            scalable and enterprise-ready customizations tailored to your
            business.
          </p>
