      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {cards.map((card, idx) => (
            ...
            >
              {/* 3-side white-gray gradient border */}
              <div className="absolute top-0 left-0 right-0 h-full rounded-t-2xl rounded-l-2xl rounded-r-2xl pointer-events-none">
                {/* Top */}
                <div className="absolute top-0 left-0 right-0 h-2 bg-gradient-to-b from-white via-gray-400 to-transparent rounded-t-2xl blur-sm"></div>
                {/* Left */}
                <div className="absolute top-0 left-0 w-2 h-full bg-gradient-to-r from-white via-gray-400 to-transparent rounded-l-2xl blur-sm"></div>
                {/* Right */}
                <div className="absolute top-0 right-0 w-2 h-full bg-gradient-to-l from-white via-gray-400 to-transparent rounded-r-2xl blur-sm"></div>
              </div>
