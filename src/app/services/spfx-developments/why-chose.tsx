...
export const WhyChooseSoftreeSPFx: React.FC = () => {
  const stats = [
    {
      value: "8+",
      label: "Years of SharePoint & SPFx Experience",
      icon: Award,
    },
    {
      value: "150+",
      label: "SPFx Web Parts & Extensions Delivered",
      icon: Globe,
    },
    {
      value: "40+",
      label: "Certified SharePoint & M365 Engineers",
      icon: Users,
    },
    {
      value: "300+",
      label: "Custom SPFx Features Implemented",
      icon: Settings,
    },
    {
      value: "20+",
      label: "Enterprise SharePoint Deployments",
      icon: Briefcase,
    },
    {
      value: "99%",
      label: "Client Satisfaction on SharePoint Projects",
      icon: Smile,
    },
  ];
  ...
  return (
    <section className="relative bg-gradient-to-br from-black via-[#0B1220] to-[#0F1A2E] py-32 text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto flex flex-col xl:flex-row gap-16 px-6">
        {/* ================= LEFT CONTENT ================= */}
        <div
        ...
        >
          ...
          >
            ...
            SharePoint Framework Specialists
          </span>
          ...
          <h2 className="text-4xl xl:text-5xl font-extrabold leading-tight">
            ...
            for SPFx & SharePoint Solutions?
          </h2>

          <p className="mt-6 text-gray-300 text-lg leading-relaxed max-w-xl">
            Softree delivers robust SharePoint Framework (SPFx) solutions that
            modernize intranets, enhance user experiences, and enable seamless
            collaboration across Microsoft 365 environments.
          </p>

          <p className="mt-3 text-gray-400 text-base leading-relaxed max-w-xl">
            Our SPFx experts build secure client-side web parts, extensions, and
            Microsoft Teams integrations using clean architecture, Microsoft
            best practices, and full compatibility with SharePoint Online.
          </p>

          {/* CTA */}
          <div className="mt-8">
            <button
              aria-label="Talk to an SPFx Expert"
