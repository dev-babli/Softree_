        ...
        <div className="relative flex flex-col items-center gap-10">
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-orange-200 text-sm max-w-2xl mx-auto">
              See how organizations across industries have transformed their operations with Softree Technology's AI consulting, Microsoft Power Platform, and enterprise automation solutions.
            </p>
          </div>
