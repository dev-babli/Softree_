...
const steps = [
  ...
  },
  {
    step: "04",
    leftCard: {
      title: "Dedicated Offshore Engineering",
      points: [
        "Microsoft AI specialists",
  ...
  },
  {
    step: "05",
    leftCard: {
      title: "Expand Your Delivery Capacity",
      points: [
        "Your brand",
        "NDA-backed teams",
  ...
  },
  {
    step: "06",
    leftCard: {
      title: "Modern Microsoft AI Solutions",
      points: [
        "Azure AI",
        "Microsoft Copilot",
        "Power Platform",
...
export default function BusinessOutcomes() {
 ...
 font-bold text-gray-900 tracking-tight mb-6 max-w-4xl mx-auto leading-tight">
            Transform AI Strategy into <span className="text-[#FF5812]">Measurable <br className="hidden md:block" /> Business Outcomes</span>
          </h2>
          <p className="text-[15px] lg:text-[17px] text-gray-500 max-w-3xl mx-auto leading-relaxed">
            Our AI consulting services help organizations move from strategy to execution, delivering measurable improvements in productivity, operational efficiency, innovation, and business growth through Microsoft's AI ecosystem.
          </p>
        </div>
