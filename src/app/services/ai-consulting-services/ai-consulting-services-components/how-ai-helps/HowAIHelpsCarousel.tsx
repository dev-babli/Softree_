...
interface HowAIHelpsCarouselProps {
  activeIndex: number;
  onSelect: (index: number) => void;
}

export function HowAIHelpsCarousel({ activeIndex, onSelect }: HowAIHelpsCarouselProps) {
  ...
  return (
    <div className="relative w-full h-[500px] lg:h-[700px] rounded-[2rem] overflow-hidden shadow-[0_20px_50px_rgba(255,107,0,0.2)] flex items-center justify-center bg-orange-950/30">
