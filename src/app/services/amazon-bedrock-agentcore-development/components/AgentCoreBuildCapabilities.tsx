...
import { Mic, Headphones, CalendarDays, TrendingUp, Briefcase, ArrowRight } from "lucide-react";





function WhatYouCanBuildContent({ simple = false }: { simple?: boolean }) {
  const items = [
    {
      title: "AI Agent Applications",
      desc: "Build production-ready AI agents using popular frameworks and models, with AgentCore Runtime providing secure, scalable infrastructure for deployment.",
      icon: Mic,
      color: "text-[#FF6B00]",
      bg: "bg-orange-50",
    },
    {
      ...
      desc: "Automate complex business workflows by connecting AI agents with enterprise applications, APIs, tools, and data sources through AgentCore Gateway.",
      icon: Headphones,
      color: "text-[#FF6B00]",
      bg: "bg-orange-50",
    },
    {
      ...
      desc: "Build agents that maintain relevant context across interactions with AgentCore Memory, supporting short-term and long-term memory for more personalized workflows.",
      icon: CalendarDays,
      color: "text-[#FF6B00]",
      bg: "bg-orange-50",
    },
    {
      ...
      desc: "Enable AI agents to securely access AWS resources, enterprise applications, and third-party services with identity, permissions, and controlled tool access.",
      icon: TrendingUp,
      color: "text-[#FF6B00]",
      bg: "bg-orange-50",
    },
    {
      title: "Production Agent Operations",
      desc: "Monitor, trace, debug, and evaluate AI agents in production with AgentCore Observability and Evaluations for continuous quality and performance monitoring.",
      icon: Briefcase,
      color: "text-[#FF6B00]",
      bg: "bg-orange-50",
    },
    ...
    <div className="flex flex-col justify-between h-full w-full lg:max-w-[660px] mx-auto lg:mx-0 px-4 lg:px-2 pt-0">
      ...
      <div className="flex flex-col justify-between flex-1">
        {items.map((item, i) => (
          <div
            key={i}
            className={`flex items-start gap-3.5 sm:gap-4 py-1.5 sm:py-2 ${i !== items.length - 1 ? "border-b border-slate-100" : ""
              }`}
          >
...
function NetworkGlobeComponent({
...
export default function AgentCoreBuildCapabilities() {
  return (
          ...
          <div className="lg:col-span-6 w-full flex flex-col h-full">
            <div className="w-full h-full max-w-[550px] lg:max-w-none flex flex-col mx-auto lg:ml-auto">
              <NetworkGlobeComponent
                heading="Deploying AI Agents Globally"
                tagline="Global Reach. Local Execution."
                subheading="Trusted by businesses across 13+ countries, our offshore engineering teams build, deploy, and scale secure AI agents with Amazon Bedrock AgentCore for enterprise workflows."
                storesLabel="13+ countries served"
              />
            </div>
          </div>
