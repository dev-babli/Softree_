...
export default function GenAiResilience() {
  return (
        ...
        <div className="relative rounded-[32px] border border-zinc-800 bg-zinc-950 p-8 md:p-12 lg:p-16 flex flex-col lg:flex-row gap-12 lg:gap-16 shadow-2xl overflow-hidden">
          ...
          <div className="flex flex-col justify-center w-full lg:w-[45%] z-10">
            <h2 className="text-3xl md:text-4xl lg:text-[42px] font-extrabold text-white leading-tight tracking-tight">
              ...
              <span className="text-[#FF5812]">Generative AI Resilience</span>
            </h2>
            
            <p className="mt-6 text-[15px] md:text-base text-zinc-400 leading-relaxed">
              While generative model architectures drive productivity, security boundaries, hallucination control, and API latency stay as the biggest hurdles. Over 90% of technical leaders require governed workflows to avoid sending sensitive data to external LLMs.
            </p>
            
            <p className="mt-4 text-[15px] md:text-base text-zinc-400 leading-relaxed">
              Softree provides full enterprise safety guardrails—building private API routing layers, monitoring model hallucinations, and ensuring active cost containment inside your private cloud boundary.
            </p>
            ...
            <div className="mt-8">
              ...
              >
                <span>Discuss Your AI Requirements</span>
                <ArrowRight size={16} />
              </Link>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 w-full lg:w-[55%] z-10 items-stretch">
            ...
            <div className="group rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 flex flex-col hover:bg-zinc-900 hover:border-zinc-700 transition-all duration-300">
              ...
              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">
                We analyze model hallucinations, audit vector database index drift, and trace data exposure vulnerabilities inside your enterprise stack.
              </p>
            </div>
            ...
            <div className="group rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 flex flex-col hover:bg-zinc-900 hover:border-zinc-700 transition-all duration-300">
              ...
              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">
                We automate prompt engineering versioning, pipeline CI/CD deployments, API failover orchestration, and semantic caching layers.
              </p>
            </div>
            ...
            <div className="group rounded-2xl bg-gradient-to-br from-[#FF6B00] via-[#FF5812] to-[#E64C00] p-6 flex flex-col border border-white/10 hover:scale-[1.01] transition-all duration-300 text-white shadow-[0_15px_30px_rgba(255,88,18,0.2)]">
              ...
              <p className="text-xs sm:text-sm text-orange-50/90 leading-relaxed">
                We enforce real-time data compliance rules, masking sensitive PII fields, intercepting jailbreaks, and storing detailed safety telemetry.
              </p>
            </div>
            ...
            <div className="group rounded-2xl border border-zinc-800 bg-zinc-900/50 p-6 flex flex-col hover:bg-zinc-900 hover:border-zinc-700 transition-all duration-300">
              ...
              <p className="text-xs sm:text-sm text-zinc-400 leading-relaxed">
                We monitor key LLM metrics, including input-output token latency, token usage efficiency, cache-hit ratios, and query accuracy logs.
              </p>
            </div>
