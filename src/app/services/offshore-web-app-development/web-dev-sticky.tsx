...
import { WEB_DEV_LANES, type WebDevLane } from "@/data/web-dev-page";
    ...
    >
      ...
      >
        <div
          ...
          style={{
            background:
              "radial-gradient(70% 55% at 18% 0%, rgba(24,82,255,0.06), transparent 65%), radial-gradient(50% 40% at 88% 100%, rgba(255,88,18,0.05), transparent 60%)",
          }}
        />
        ...
        <div className="relative z-10 mx-auto w-full px-6 md:px-10">
          ...
          >
            <div className="flex flex-col">
              ...
              <Link
                href={lane.href}
                className="mt-8 inline-flex w-max items-center gap-2 rounded-full border border-[#0a0a1a]/12 bg-[#0a0a0a] px-6 py-3 text-[11px] font-semibold uppercase tracking-[0.12em] text-white transition hover:bg-[#0a0a0a]/90"
              >
                Talk to our team
              </Link>
            </div>
...
export default function WebDevSticky() {
  return (
    <section
      data-section="web-dev-sticky"
      className="relative w-full border-t border-[#0a0a1a]/[0.06]"
      style={{ backgroundColor: SURFACE }}
      aria-labelledby="web-dev-sticky-heading"
    >
        ...
        >
          <SectionHeader
            ...
            headline={
              ...
              >
                Four lanes — scroll the stack.
              </span>
            }
            body="Each card pins and hands off to the next. Frontend, platform, cloud, and launch quality — one squad."
          />
        </motion.div>
      </div>

      <div className="relative">
        {WEB_DEV_LANES.map((lane, i) => (
          <StickyLaneCard
            key={lane.id}
            lane={lane}
            index={i}
            total={WEB_DEV_LANES.length}
          />
        ))}
      </div>
