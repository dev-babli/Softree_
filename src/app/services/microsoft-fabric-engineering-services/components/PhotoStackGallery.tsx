...
const DEFAULT_PHOTOS: StackPhoto[] = [
  {
    ...
    caption: "Define Fabric architecture, OneLake strategy, governance, and implementation roadmaps.",
    location: "Role 01 • Architecture & Strategy",
    category: "[ ARCHITECTURE & STRATEGY ]",
    status: "● SPECIALIZED TALENT",
    specs: [
      { label: "FOCUS", value: "Fabric Architecture" },
      { label: "DESIGN", value: "OneLake Strategy" },
  ...
  },
  {
    ...
    caption: "Build production-ready Fabric solutions across Lakehouse, Warehouse, and Real-Time Intelligence.",
    location: "Role 02 • Fabric Engineering",
    category: "[ FABRIC ENGINEERING ]",
    status: "● SPECIALIZED TALENT",
    specs: [
      { label: "SOLUTIONS", value: "Lakehouse & Warehouse" },
      { label: "PIPELINES", value: "Dataflows Gen2 & Spark" },
      { label: "REAL-TIME", value: "Real-Time Intelligence" }
    ]
  },
  {
    id: "03",
    title: "Fabric Data Engineers",
    caption: "Build reliable data pipelines, ETL/ELT workflows, and robust OneLake data foundations.",
    location: "Role 03 • Data Engineering",
    category: "[ DATA ENGINEERING ]",
    status: "● SPECIALIZED TALENT",
    specs: [
      { label: "PIPELINES", value: "ETL/ELT Workflows" },
      { label: "DATA", value: "Spark Processing" },
      { label: "FOUNDATION", value: "OneLake Foundations" }
    ]
  },
  {
    id: "04",
    title: "Power BI & Analytics Engineers",
    caption: "Build semantic models, Power BI dashboards, KPI analytics, and self-service BI.",
    location: "Role 04 • Analytics & BI",
    category: "[ ANALYTICS & BI ]",
    status: "● SPECIALIZED TALENT",
    specs: [
      { label: "MODELS", value: "Semantic & Direct Lake" },
      { label: "REPORTS", value: "Power BI Dashboards" },
      { label: "BI", value: "Self-Service Analytics" }
    ]
  },
  {
    id: "05",
    title: "Fabric Integration & Migration Engineers",
    caption: "Connect Fabric with enterprise systems and support data platform modernization.",
    location: "Role 05 • Integration & Modernization",
    category: "[ INTEGRATION & MODERNIZATION ]",
    status: "● SPECIALIZED TALENT",
    specs: [
      { label: "CONNECT", value: "ERP & SaaS Integration" },
      { label: "MIGRATE", value: "Platform Modernization" },
      { label: "ENTERPRISE", value: "Unified Data Systems" }
    ]
  },
  {
    id: "06",
    title: "Cloud & DevOps Engineers",
    caption: "Deploy, secure, monitor, and optimize Microsoft Fabric environments in production.",
    location: "Role 06 • Cloud & Production",
    category: "[ CLOUD & PRODUCTION ]",
    status: "● SPECIALIZED TALENT",
    specs: [
      { label: "DEPLOY", value: "Production Environments" },
      { label: "MONITOR", value: "Performance & Health" },
      { label: "SUPPORT", value: "Continuous Operations" }
    ]
  }
];
