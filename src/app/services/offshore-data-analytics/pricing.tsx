...
export default function HirePowerBIPricing() {
  return (
    <section id="plan-pricing" className="relative py-14">
      <div className="mx-auto max-w-7xl px-6">
        ...
        rounded-2xl
        bg-gradient-to-br from-white via-white to-orange-50/40
      ...
      "
          ...
          <div className="grid grid-cols-1 gap-7 md:grid-cols-3 lg:col-span-3">
            {[
              ...
              text-white
              shadow-[0_18px_50px_rgba(249,115,22,0.35)]
              scale-[1.03]
            `
                    : `
              bg-white
