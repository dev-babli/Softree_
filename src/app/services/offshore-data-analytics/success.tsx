    ...
    <section className="relative py-36 overflow-hidden">
      <div className="relative max-w-7xl mx-auto px-6">
        ...
        <div className="text-center max-w-4xl mx-auto mb-28">
          <div className="mx-auto mb-6 h-px w-24 bg-gradient-to-r from-transparent via-orange-200 to-transparent" />
          ...
          <h2 className="text-4xl md:text-5xl font-semibold text-white">
            ...
            <span className="relative inline-block mt-2 text-orange-500">
              ...
              <span className="absolute -bottom-2 left-0 right-0 h-[2px] bg-orange-500/40" />
            </span>
          </h2>
          ...
          {stories.map((item, i) => (
            ...
            >
              ...
              <div className="relative rounded-3xl overflow-hidden transition-all duration-700 group-hover:-translate-y-3">
                {/* Aurora glow */}
                <div className="absolute -inset-10 bg-[radial-gradient(circle_at_top_left,rgba(249,115,22,0.35),transparent_45%)] opacity-70" />
                <div className="absolute -inset-10 bg-[radial-gradient(circle_at_bottom_right,rgba(245,158,11,0.25),transparent_45%)] opacity-70" />

                {/* Gradient border */}
                <div className="absolute inset-0 rounded-3xl p-[1.5px] bg-gradient-to-br from-orange-400 via-amber-500 to-rose-600">
                  <div className="h-full w-full rounded-3xl bg-gradient-to-br from-[#0f0a06] via-[#1f1004] to-[#2b1602]" />
                </div>
                ...
                <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-10 min-h-[520px] rounded-3xl shadow-[0_40px_140px_rgba(0,0,0,0.65)]">
                  ...
                  <div className="relative p-14 flex flex-col justify-center">
                    <div className="absolute inset-0 bg-gradient-to-br from-orange-500/15 via-amber-500/10 to-transparent" />

                    <h3 className="relative text-3xl font-semibold text-white leading-tight">
                      {item.title}
                    </h3>

                    <p className="relative mt-6 text-orange-100/85 leading-relaxed text-lg">
                      {item.desc}
                    </p>

                    <div className="relative mt-10 h-[3px] w-24 bg-gradient-to-r from-orange-400 via-amber-500 to-rose-600 rounded-full" />
                  </div>
                  ...
                  <div className="relative h-[520px] p-6">
                    <div className="relative h-full w-full overflow-hidden rounded-2xl shadow-2xl">
                      ...
                      <div className="absolute bottom-6 right-6 w-14 h-14 rounded-full bg-gradient-to-br from-orange-400/80 to-amber-500/80 backdrop-blur-md flex items-center justify-center text-white text-xl opacity-0 translate-y-3 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500 shadow-lg">
                        →
                      </div>
                    </div>
                  </div>
