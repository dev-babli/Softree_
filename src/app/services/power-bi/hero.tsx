...
export default function HeroWithTestimonial() {
  ...
  const testimonials = [
    {
      text: "The Power BI dashboards give us real-time visibility into our KPIs across departments.",
      name: "Rohit Desai",
      role: "Chief Operations Officer",
      avatar: "https://i.pravatar.cc/100?img=12",
    },
    {
      text: "Our executive reporting is now automated with secure Power BI integration across Microsoft 365.",
      name: "Priya Nair",
      role: "Finance Head",
      avatar: "https://i.pravatar.cc/100?img=25",
    },
    {
      text: "Advanced analytics and data modeling helped us make faster, data-driven decisions.",
      name: "Karan Malhotra",
