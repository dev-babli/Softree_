...
export default function PowerBIHero() {
  ...
  return (
    ...
    "
        >
          Build <span className="text-blue-400">Data-Driven</span> Power BI
          Dashboards
    ...
    "
        >
          ...
          <span className="text-white font-semibold">real-time</span> Power BI
          solutions that transform raw data into actionable insights — from
          executive dashboards to{" "}
