...
export function IndustryCard({ industry, isActive }: IndustryCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`relative w-full h-full min-h-100 sm:min-h-[450px] flex flex-col rounded-4xl overflow-hidden group transition-all duration-300 border-[1.5px] ${isActive
    ...
    >
      ...
      <div className="relative h-[200px] w-full shrink-0 bg-slate-100 z-0">
        ...
        <div className="absolute inset-0 bg-linear-to-t from-black/40 via-black/5 to-transparent mix-blend-multiply" />
      </div>
