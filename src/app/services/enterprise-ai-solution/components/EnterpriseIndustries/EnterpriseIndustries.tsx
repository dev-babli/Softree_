...
export const EnterpriseIndustries = () => {
  return (
    <section className="relative py-12 md:py-16 lg:py-20 overflow-hidden bg-linear-to-b from-zinc-50 via-white to-zinc-50">
      <div className="relative z-10">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12 lg:mb-16 px-4">
          ...
          >
            Enterprise-Scale <span className="text-[#FF5812]">AI Production Solutions</span>
          </motion.h2>
          ...
          >
            We help organisations across healthcare, manufacturing, finance, retail, logistics, and education architect and deploy AI systems that solve real business challenges and deliver measurable ROI at scale.
          </motion.p>
        </div>
