...
export default function AutoScrollColumn({
    ...
    return (
        <div
            className={`flex-1 rounded-3xl p-6 lg:p-8 shadow-[0_8px_30px_rgb(0,0,0,0.03)] border flex flex-col h-125 ${!isRight ? 'bg-[#FF5812] border-[#E84E0F]' : 'bg-[#FDFDFD] border-[#F0F0F0]'}`}
        ...
        >
            <div className="flex items-center gap-3 mb-6 relative z-20">
                ...
                <h3 className={`text-xl font-bold border-b-2 pb-1 ${isRight ? 'text-slate-900 border-orange-500' : 'text-white border-white/30'}`}>
                    {isRight ? "AI Development Solutions" : "Business Challenges"}
                </h3>
            </div>
