...
export const SuccessStoriesCarousel = () => {
  ...
  return (
    <motion.div variants={fadeUpVariant} className="relative w-full max-w-7xl mx-auto mt-16 pb-12">
      {/* Navigation Buttons */}
      ...
      <div className="overflow-hidden" ref={emblaRef}>
        <div className="flex touch-pan-y -ml-4">
          {successStoriesData.map((story, index) => (
            <div
              key={story.id}
              className="flex-[0_0_85%] min-w-0 pl-4 sm:flex-[0_0_65%] md:flex-[0_0_48%] lg:flex-[0_0_32%] py-12"
            >
              <SuccessStoryCard 
                story={story} 
