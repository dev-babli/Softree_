...
const steps = [
  {
    step: "01",
    leftCard: {
      title: "Move Pilots to Production",
      points: [
        "Prioritized enterprise use cases",
        "Clear success metrics and owners",
        "Hardened security before scale",
        "Phased rollout with evaluation gates",
      ],
    },
    rightCard: {
      title: "Business Impact",
      points: [
        "Stop endless proof-of-concept cycles",
        "Fund the highest-ROI opportunities",
        "Reduce failed experiment waste",
        "Create a repeatable delivery path",
      ],
    }
  },
  {
    step: "02",
    leftCard: {
      title: "Unlock Enterprise Knowledge",
      points: [
        "Enterprise RAG over trusted sources",
        "Permission-aware retrieval",
        "SharePoint, CRM, and data grounding",
    ...
    rightCard: {
      ...
      points: [
        ...
        "Fewer incorrect AI responses",
        "Lower search and support burden",
  ...
  },
  {
    step: "03",
    leftCard: {
      title: "Automate Cross-System Work",
      points: [
        "Agents and copilots with tool access",
        "CRM, ERP, and M365 integrations",
  ...
  },
  {
    ...
    rightCard: {
      title: "Business Impact",
      points: [
        "Safer production AI operations",
        "Traceable model and prompt use",
        "Reduced regulatory risk",
        "Leadership confidence to scale",
      ],
    }
  },
  {
    ...
    rightCard: {
      title: "Business Impact",
      points: [
        "Faster expansion beyond first wins",
        "Lower rebuild cost per use case",
  ...
  },
  {
    step: "06",
    leftCard: {
      title: "Drive Adoption and ROI",
      points: [
        "Change enablement and training",
        "Admin runbooks and ownership",
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-12">
        ...
        <div className="mx-auto mb-16 max-w-5xl text-center">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-[2.25rem] font-extrabold text-gray-900 tracking-tight mb-6 max-w-5xl mx-auto leading-tight">
            Turn Enterprise AI into Measurable <span className="text-[#FF5812]">Business Outcomes</span>
          </h2>
          <p className="text-[15px] lg:text-base text-gray-500 max-w-3xl mx-auto leading-relaxed">
            Our Enterprise AI Solutions help organizations prioritize use cases, ground systems in trusted knowledge, automate cross-system work, govern production AI, and drive adoption with measurable ROI.
          </p>
        </div>
