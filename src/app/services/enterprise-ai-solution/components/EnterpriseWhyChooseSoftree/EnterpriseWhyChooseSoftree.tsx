...
export default function EnterpriseWhyChooseSoftree() {
        ...
        <section className="text-gray-900 py-12 md:py-16 lg:py-20">
            <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div className="relative">
                    ...
                    <div className="absolute left-4 top-30 bottom-0 w-px bg-linear-to-b from-orange-500/40 via-orange-400/20 to-transparent hidden md:block" />
                ...
                {/* ================= RIGHT : TESTIMONIALS ================= */}
                <div className="rounded-2xl p-10 bg-linear-to-r from-black via-[#4c1c02] to-black border border-white/10 shadow-2xl">
                    {/* Header */}
                    <div className="mb-10">
