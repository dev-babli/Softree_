...
import ReactWebDevelopmentStoryExperience from "./ReactWebDevelopmentStoryExperience"
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "/services/digital-workspace/react-web-development",
  },
  keywords: [
  ...
  openGraph: {
    ...
    url: "/services/digital-workspace/react-web-development",
...
const serviceJsonLd = {
  ...
  url: "https://softree.in/services/digital-workspace/react-web-development",
  description:
    "React and Next.js websites, landing pages, SaaS frontends, dashboards, and web applications built with UX, performance, SEO, and launch support.",
  hasOfferCatalog: {
    "@type": "OfferCatalog",
...
const breadcrumbJsonLd = {
  ...
  itemListElement: [
    ...
    },
    {
      ...
      position: 3,
      name: "React Web Development Services",
      item: "https://softree.in/services/digital-workspace/react-web-development",
    },
  ],
}

export default function ReactWebDevelopmentPage() {
  return (
    <main className="relative min-h-[100dvh] bg-[#080a0c] text-white">
      ...
      />
      <NavigationClient />
      <ReactWebDevelopmentStoryExperience />
    </main>
  )
}
