// WebGL Shader Slider - Softree AI Voice Solutions Built with Amazon Nova 2 Sonic
"use client";
...
const NOVA_SLIDES: NovaSlide[] = [
  ...
  {
    id: "enterprise-voice-automation",
    number: "03",
  ...
  {
    id: "voice-knowledge-assistants",
    number: "04",
    tag: "Enterprise RAG & Data",
  ...
  {
    id: "healthcare-voice-assistants",
    number: "05",
  ...
  {
    id: "field-service-voice-assistants",
    number: "06",
    tag: "Field & Mobile Ops",
  ...
  {
    id: "multilingual-voice-experiences",
    number: "07",
    tag: "Global Support",
...
export default function NovaVoiceSolutionsArc() {
    ...
    <section className="relative w-full bg-white text-slate-900 pt-12 md:pt-18 pb-16 md:pb-24 overflow-hidden select-none font-sans">
      ...
      <div className="relative z-10 w-full max-w-[1700px] mx-auto px-4 sm:px-6 lg:px-[2cm] text-center mb-6 md:mb-8">
        <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full border border-orange-200 bg-orange-50 typo-caption text-[#FF6B00] uppercase mb-4 shadow-2xs">
          ...
          AMAZON NOVA 2 SONIC SOLUTIONS
        </div>

        <h2 className="typo-heading-2 text-slate-900 mb-4 max-w-4xl mx-auto leading-tight">
          Softree AI Voice Solutions Built with{" "}
          <span className="text-[#FF6B2C]">Amazon Nova 2 Sonic</span>
        </h2>

        <p className="typo-description text-slate-600 max-w-3xl mx-auto mb-2">
          Softree builds real-time voice AI applications with Amazon Nova 2 Sonic, connecting
          conversational intelligence with business workflows, knowledge systems, APIs, and
      ...
      <div className="relative z-10 w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-[2cm] mt-6">
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-16 sm:bottom-20 z-20 px-5 sm:px-8 lg:px-12 max-w-4xl">
            <h3
              className="typo-heading-3 text-white mb-3 drop-shadow-md"
              id="mainTitle"
            >
            ...
            <Link
              href="/contact"
              className="inline-flex items-center gap-2 px-5 py-2.5 rounded-full bg-[#FF5812] hover:bg-[#e04d0f] text-white typo-button shadow-lg shadow-orange-500/25 transition-all duration-200 hover:scale-105 active:scale-95"
            >
              <span>Build With Nova 2 Sonic</span>
