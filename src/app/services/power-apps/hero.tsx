...
export default function HeroWithTestimonial() {
 ...
 bg-clip-text text-transparent"
            >
              Power Apps for Enterprise
            </span>
          </h1>

          <p className="text-zinc-300 text-lg leading-relaxed max-w-xl">
            We architect secure, scalable and high-performance Power Apps that
            streamline operations, automate workflows and seamlessly integrate
            with Microsoft 365, SharePoint and the Power Platform ecosystem.
          </p>
