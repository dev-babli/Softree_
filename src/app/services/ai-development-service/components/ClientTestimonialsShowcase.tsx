  ...
  const col2Items = [
    {
      type: "text",
      brand: "AMERICANA",
      comment: "Our search for an industry leader that could design, integrate, and digitally engineer fluid and eye-pleasing apps in restaurant space ended with Softree. The agency helped us unlock opportunities by building specialized capabilities that empower scalability.",
      name: "Mohit Mendiratta",
      role: "Director, Americana Group",
      avatar: "MM"
    },
    {
      type: "text",
