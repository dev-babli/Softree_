...
const steps = [
  {
    step: "01",
    leftCard: {
      title: "Deflect Routine Support Volume",
      points: [
        "24/7 FAQ and how-to answers",
        "Intent detection for common intents",
        "Guided troubleshooting flows",
        "Self-service for account basics",
      ],
    },
    rightCard: {
      title: "Business Impact",
      points: [
        "Lower ticket volume for agents",
        "Faster first response anytime",
        "Consistent answer quality",
        "Free teams for complex cases",
      ],
    }
  },
  {
    step: "02",
    leftCard: {
      title: "Ground Answers in Trusted Knowledge",
      points: [
        "Enterprise RAG over docs and FAQs",
        "SharePoint and CMS grounding",
  ...
  },
  {
    step: "03",
    leftCard: {
      title: "Integrate Helpdesk and CRM",
      points: [
        "Zendesk, ServiceNow, Dynamics",
        "Ticket create and status updates",
        "Customer context from CRM",
        "Secure API and auth patterns",
      ],
    },
    rightCard: {
      title: "Business Impact",
      points: [
        "Actions without app switching",
        "Richer context for live agents",
        "Smoother bot-to-human handoff",
        "Closed-loop support workflows",
      ],
    }
  },
  {
    step: "04",
    leftCard: {
      title: "Improve CSAT and Containment",
      points: [
        "Clear escalation paths",
        "Confidence-based routing",
        "Multichannel web and Teams",
        "Conversation analytics loops",
      ],
    },
    rightCard: {
      title: "Business Impact",
      points: [
        ...
        "Data to improve intents weekly",
      ],
    }
  },
  {
    step: "05",
    leftCard: {
      title: "Scale Conversations Across Channels",
      points: [
        "Reusable chatbot architecture",
        "Website, portal, and Teams bots",
        "Role-aware employee assistants",
        "Shared NLU and knowledge layer",
      ],
    },
    rightCard: {
      title: "Business Impact",
      points: [
        "One design, many touchpoints",
        "Support growing chat volume",
        "Standard conversational UX",
        "Faster rollout to new brands",
      ],
    }
  },
  {
    step: "06",
    leftCard: {
      title: "Operate Chatbots Securely",
      points: [
        "Role-based access control",
        "Enterprise authentication",
        "PII redaction and audit logs",
        "Monitoring and content filters",
      ],
    },
    rightCard: {
      title: "Business Impact",
      ...
      <div className="relative mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-12">
        ...
        <div className="mx-auto mb-16 max-w-5xl text-center">
          ...
          <h2 className="text-2xl md:text-4xl lg:text-[2.25rem] font-extrabold text-gray-900 tracking-tight mb-6 max-w-5xl mx-auto leading-tight">
            Turn AI Chatbots into Measurable <span className="text-[#FF5812]">Business Outcomes</span>
          </h2>
          <p className="text-[15px] lg:text-base text-gray-500 max-w-3xl mx-auto leading-relaxed">
            Our AI chatbot development services help enterprises deflect support volume, ground answers in trusted knowledge, integrate helpdesk systems, and launch secure conversational experiences that improve CSAT.
          </p>
        </div>
