...
export function TransferredSoftreeHero() {
  ...
  return (
    <section ref={containerRef} className="relative h-screen w-full shrink-0 bg-[#fafaf9] overflow-x-clip">
      <div className="sticky top-0 h-screen w-full overflow-hidden flex flex-col items-center">
        ...
        <div className="hero-text-cluster absolute inset-0 z-20 flex flex-col justify-center pt-[12vh] pb-[20vh] pl-[8vw] pr-[4vw] pointer-events-none">
          <div className="max-w-[640px] text-left pointer-events-auto">
            ...
            {/* Headline */}
            <h1
              className="hero-title text-white text-[clamp(28px,4.5vw,72px)] font-semibold leading-[1.0] tracking-[-0.04em]"
              style={{ willChange: "transform, opacity" }}
            >
              Production-grade enterprise software, shipped in 6–12 weeks.
            </h1>
            ...
            <p
              ...
              style={{ willChange: "transform, opacity" }}
            >
              AI agents, Power Platform, and web apps for ambitious enterprise teams. Fixed scope, fixed price, code you own from day one.
            </p>

            {/* CTA */}
            <Link
              href="/contact"
              className="hero-btn mt-8 inline-flex items-center gap-2 rounded-full bg-zinc-950 px-7 py-3.5 text-[14px] font-semibold text-white shadow-xl transition-colors hover:bg-zinc-800 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50"
              style={{ willChange: "transform, opacity" }}
              onClick={() => { if (typeof window !== 'undefined') window.dataLayer?.push({ event: 'cta_click', cta_location: 'hero', cta_text: 'Book a 15-min scoping call' }) }}
            >
              Book a 15-min scoping call
            </Link>

            {/* Stat row — real proof signals */}
            <div className="mt-10 flex flex-col sm:flex-row items-start sm:items-center gap-4 sm:gap-6">
              <div>
                <span className="text-white text-[22px] font-semibold">47 days</span>
                <span className="block text-white/60 text-[11px] mt-0.5">median ship time</span>
              </div>
              <span className="hidden sm:block w-px h-8 bg-white/20" aria-hidden="true" />
              <div>
                <span className="text-white text-[22px] font-semibold">200+</span>
                <span className="block text-white/60 text-[11px] mt-0.5">enterprise projects</span>
              </div>
              <span className="hidden sm:block w-px h-8 bg-white/20" aria-hidden="true" />
              <div>
                <span className="text-white text-[14px] font-semibold">Microsoft Gold Partner</span>
                <span className="block text-white/60 text-[11px] mt-0.5">Power Platform &amp; M365</span>
              </div>
            </div>
        ...
        >
          <div className="max-w-2xl text-center pointer-events-auto">
            <h2 className="text-zinc-900 text-[clamp(28px,3.5vw,56px)] font-black leading-none">
              AI. Web. Microsoft. One senior team — no handoffs.
            </h2>
        ...
        <div className="absolute inset-x-0 bottom-0 z-30 flex items-end justify-center pointer-events-none">
          ...
          >
            ...
            <div className="absolute bottom-0 inset-x-0 p-5 flex flex-col">
              ...
              <Link href="/services/digital-workspace/web-app-development" className="mt-3 self-start inline-flex items-center gap-1.5 bg-white/90 text-zinc-900 text-xs font-bold px-4 py-2 rounded-full transition-all hover:bg-white pointer-events-auto shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50">
          ...
          >
            ...
            <div className="absolute bottom-0 inset-x-0 p-5 flex flex-col">
              ...
              <Link href="/services/ai-intelligence/agentic-ai" className="mt-3 self-start inline-flex items-center gap-1.5 bg-white/90 text-zinc-900 text-xs font-bold px-4 py-2 rounded-full transition-all hover:bg-white pointer-events-auto shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50">
          ...
          >
            ...
            <div className="card-ui absolute inset-x-0 bottom-0 z-[4] opacity-0 pointer-events-none" style={{ willChange: "opacity" }}>
              <div className="bg-gradient-to-t from-black/80 via-black/20 to-transparent rounded-b-xl p-5 flex flex-col">
                ...
                <Link href="/services/business-applications" className="mt-3 self-start inline-flex items-center gap-1.5 bg-white/90 text-zinc-900 text-xs font-bold px-4 py-2 rounded-full transition-all hover:bg-white pointer-events-auto shadow-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/50">
