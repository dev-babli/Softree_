import SeoPreviewInput from "@/cms/studio/inputs/SeoPreviewInput"
import React, { type ComponentType } from "react"
import { defineField } from "sanity"
import EditorProgressInput from "@/cms/studio/inputs/EditorProgressInput"
import FaqAeoPanelInput from "@/cms/studio/inputs/FaqAeoPanelInput"
import ContentScorePanel from "@/cms/studio/inputs/ContentScorePanel"
...
export function createContentScorePanelField(group = "publish") {
  return createUiShellField({
    name: "contentScoreUi",
    title: "Content score",
    group,
    input: ContentScorePanel,
  })
}
