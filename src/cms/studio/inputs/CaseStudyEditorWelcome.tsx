...
import { effectiveCaseStudyCategory } from '@/cms/lib/studio/caseStudyLegacy'
...
function useCaseStudySteps() {
  ...
  const resolvedCategory = effectiveCaseStudyCategory({
    category,
    industry,
    useCase,
    detailLayout,
  ...
  const steps: Step[] = [
    {
      ...
      done: isCaseStudyCategory(category ?? '') || !!resolvedCategory,
      tab: 'story',
    },
    {
      id: 'title',
