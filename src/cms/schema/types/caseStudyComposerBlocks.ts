...
import ReactBitsComponentInput from '@/cms/studio/inputs/ReactBitsComponentInput'
import { sectionCommonFields, sectionStyleGroups } from '@/cms/schema/objects/sectionCommonFields'
...
export const csMetricsSectionType = defineType({
  ...
  groups: sectionStyleGroups,
  fields: [
    defineField({ name: 'label', title: 'Section label', type: 'string', initialValue: 'Impact', group: 'content' }),
    defineField({ name: 'heading', title: 'Heading', type: 'string', initialValue: 'Results & business impact', group: 'content' }),
    defineField({
      name: 'metrics',
      title: 'Metrics',
      type: 'array',
