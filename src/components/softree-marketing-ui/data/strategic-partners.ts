 ...
 *
 * Source: `public/softree-source-sections.html` — the `.grid._2-column` containing
    ...
    cards: [
        {
            ...
            heading: 'Microsoft',
            body:
                'Deploy the Softree Agent Platform and AI solutions within Microsoft ' +
            ...
            cta: {
                ...
                ariaLabel: 'Discover more about Softree and Microsoft partnership',
            ...
            secondaryCta: {
                ...
                href: 'https://azuremarketplace.microsoft.com/en-us/marketplace/apps?search=softreetechnology.com&page=1',
        ...
        },
        {
            ...
            heading: 'AWS',
            body:
                'The Softree Agent Platform and AI solutions are integrated with AWS ' +
            ...
            cta: {
                ...
                ariaLabel: 'Discover more about Softree and AWS partnership',
                variant: 'ghost', // is-ghost="" (empty)
                target: '_blank',
                rel: 'noopener noreferrer',
            },
