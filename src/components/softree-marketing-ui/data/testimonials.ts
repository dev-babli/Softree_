 ...
 *
 * Source: `public/softree-source-sections.html` — the "Customer testimonials"
...
const slides: readonly TestimonialSlide[] = [
    ...
    },
    {
        ...
        quote:
            'Since we started with Softree, we’ve deployed 60 AI agents across the ' +
    ...
    },
    {
        ...
        role: 'CEO, Mphasis',
        quote:
            'We are proud to be a strategic implementation partner of Softree, and we ' +
            'feel especially confident knowing that Softree’s foundation on AWS, ' +
    ...
    },
    {
        ...
        quote:
            '“Our strategic partnership with Softree marks a significant milestone in ' +
            'our mission to accelerate enterprise AI transformation. By integrating ' +
            'Softree’s advanced conversational and GenAI capabilities with Microsoft’s ' +
    ...
    },
    {
        ...
        quote:
            ...
            'leadership into our own workplace. Our work with Softree shows what\'s ' +
    ...
    },
    {
        ...
        quote:
            ...
            'Partnering with Softree amplified our ability to deliver empathetic, ' +
    ...
    },
    {
        ...
        quote:
            ...
            'we partnered with Softree to integrate AI into our customer and employee ' +
    ...
    },
    {
        ...
        quote:
            ...
            'evolving how we deliver healthcare support. With Softree, we’ve moved from ' +
    ...
    },
    {
        ...
        role: 'CAIO, G42',
        quote:
            'Partnering with Softree aligns perfectly with our mission to develop ' +
