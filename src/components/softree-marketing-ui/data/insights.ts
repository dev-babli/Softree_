 ...
 *
 * Source: `public/softree-source-sections.html` — the `.blogs_hero-section.for-homepage`
 * block containing:
...
/** Props for `SoftreeAgenticInsights` (design.md). */
export interface SoftreeAgenticInsightsProps {
...
export const aiInsightsData: SoftreeAgenticInsightsProps = {
    heading: 'AI Insights',
    viewAllCta,
    featured: {
