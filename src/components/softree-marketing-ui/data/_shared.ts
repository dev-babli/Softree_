/**
 * Shared data primitives for the Softree homepage clone fixtures.
 *
 * These interfaces are documented in design.md ("Data Models → Shared
 * Primitives") and are the canonical shapes imported by every
 * `src/components/softree-marketing-ui/data/<section>.ts` fixture. They live here (rather than
 ...
 * from `src/components/softree-marketing-ui/data/types.ts` if present; it is not present, so the
