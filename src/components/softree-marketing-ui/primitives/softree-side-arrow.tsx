...
/**
 * Props for {@link SoftreeSideArrow}.
 */
export interface SoftreeSideArrowProps {
...
/**
 * `SoftreeSideArrow` — the `sideArrowFlow` keyframe child used by the Hero side
 ...
 */
export function SoftreeSideArrow({
    className,
    ariaLabel,
}: SoftreeSideArrowProps): React.JSX.Element {
