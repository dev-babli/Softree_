...
export interface SoftreeModalProps {
...
/**
 * `SoftreeModal` — the accessible dialog primitive shared by every Softree
 ...
 * video play/pause/reset are the `SoftreeModalsLayer`'s concern.
 *
 * Responsibilities:
...
}: SoftreeModalProps): ReactPortal | null {
