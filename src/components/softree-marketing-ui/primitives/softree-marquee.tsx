 ...
 */
export interface SoftreeMarqueeProps {
    /**
...
/**
 * `SoftreeMarquee` — the `marqueeSlide` keyframe wrapper used by the Industry_Tabs
 ...
 */
export function SoftreeMarquee({
    children,
    durationToken = 'd20s',
    className,
    ariaHidden,
}: SoftreeMarqueeProps): React.JSX.Element {
