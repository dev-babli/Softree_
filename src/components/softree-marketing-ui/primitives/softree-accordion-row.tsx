...
/**
 * `SoftreeAccordionRow` — the CSS-only collapsible row used by the Navigation
 ...
 */
export interface SoftreeAccordionRowProps {
...
export function SoftreeAccordionRow({
    heading,
    children,
    defaultOpen = false,
    open,
    ...
    idBase,
    icon = 'chevron',
}: SoftreeAccordionRowProps): React.JSX.Element {
    ...
    const containerClassName = className
        ? `softree-accordion-row ${className}`
        : 'softree-accordion-row';
        ...
        <div data-accordion-list="css" className={containerClassName}>
            <div data-accordion={active ? 'active' : 'not-active'}>
                <button
                    ...
                    className="softree-accordion-row__trigger"
                >
                    <span className="softree-accordion-row__heading">{heading}</span>
                ...
                <div
                    ...
                    inert={!active}
                >
                    <div className="softree-accordion-row__content overflow-hidden">
                        {children}
                    </div>
                </div>
            </div>
