/**
 * `SoftreeSectionPill` — the uppercase Source Code Pro "eyebrow" pill label used as
 * a section tag throughout the Softree homepage (Source_Document `.section-tag`).
 *
 ...
 */
export interface SoftreeSectionPillProps {
...
export function SoftreeSectionPill({
    label,
    bgBlur,
    className,
}: SoftreeSectionPillProps) {
