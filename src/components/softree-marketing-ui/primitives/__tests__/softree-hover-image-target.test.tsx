 ...
 *
 * Unit tests for the `SoftreeHoverImageTarget` primitive (task 3.9).
 *
...
import { SoftreeHoverImageTarget } from '../softree-hover-image-target';
import {
    HoverImageContext,
...
describe('SoftreeHoverImageTarget', () => {
    it('renders its child without introducing an extra wrapper element', () => {
        render(
            <SoftreeHoverImageTarget dataImg="https://cdn.example/x.webp">
                <a href="/guide" data-testid="target">
                    Guide
                </a>
            </SoftreeHoverImageTarget>,
        );
    ...
    it('mirrors the `data-img` attribute for DOM parity (Req 16.2)', () => {
        ...
        render(
            <SoftreeHoverImageTarget dataImg={url}>
    ...
    it('omits `data-img` when there is no preview (Req 16.6)', () => {
        render(
            <SoftreeHoverImageTarget dataImg={null}>
                <a data-testid="target">Guide</a>
            </SoftreeHoverImageTarget>,
        );
    ...
    it('re-registers when dataImg changes', () => {
        ...
        const { rerender } = render(
            <HoverImageContext.Provider value={registry}>
                <SoftreeHoverImageTarget dataImg="https://cdn.example/a.webp">
                    <a data-testid="target">Guide</a>
                </SoftreeHoverImageTarget>
            </HoverImageContext.Provider>,
        );
        ...
        rerender(
            <HoverImageContext.Provider value={registry}>
                <SoftreeHoverImageTarget dataImg="https://cdn.example/b.webp">
                    <a data-testid="target">Guide</a>
                </SoftreeHoverImageTarget>
            </HoverImageContext.Provider>,
        );
