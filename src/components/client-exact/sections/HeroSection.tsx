...
import { HeroDepthParallaxBackground } from "./HeroDepthParallaxBackground"

/**
 * Exact Hanza scroll transform (probed from hanza-template.framer.website):
 * progress 0→1 through hero → translateY 0→220px, opacity 1→0.55 (no scale zoom)
 */
  ...
  return (
    ...
    >
      <div className="framer-1he253f" data-framer-name="Image Wrapper">
              ...
              <div className="framer-opytkn" data-framer-name="Content">
                ...
                >
                  ...
                  >
                    ...
                    {hero.headlineRestSegments.map((segment, i) =>
                      segment.accent ? (
                        <span key={i} className="framer-text cx-hero-em">
                          {segment.text}
                        </span>
                      ) : (
                        segment.text
        ...
        <div
          ref={mediaRef}
          className="framer-1278xai-container cx-hero-depth-wrap"
          style={{ willChange: "transform", opacity: 1, transform: "none" }}
          aria-hidden="true"
        >
          <HeroDepthParallaxBackground />
        </div>
      </div>
    </section>
  )
