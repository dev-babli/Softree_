 ...
 * the single preview element lives in `KoreHoverImagePreview` (task 18.1) and
 * each {@link KoreHoverImageTarget} registers its rendered DOM node here.
 */
 ...
 * mounted above a {@link KoreHoverImageTarget}.
 *
 ...
 * before the page-level `KoreHoverImagePreview` provider exists. No DOM
 ...
 *
 * The real registry is supplied by `KoreHoverImagePreview`
 * (`src/components/kore/sections/kore-hover-image-preview.tsx`, task 18.1),
