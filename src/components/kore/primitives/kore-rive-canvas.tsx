...
/**
 * Minimal poster shape consumed by {@link KoreRiveCanvas}.
 *
 ...
 */
export interface KoreRiveCanvasPoster {
...
/**
 * Props for {@link KoreRiveCanvas}.
 */
export interface KoreRiveCanvasProps {
    /**
     ...
     * (Req 6.9, 26.5).
     */
    readonly poster: KoreRiveCanvasPoster;
...
/**
 * `KoreRiveCanvas` — the poster-backed `@rive-app/canvas` mount used by every
 ...
 */
export function KoreRiveCanvas({
    riveSrc,
    poster,
    className,
    canvasClassName,
    ...
    height,
    ariaLabel,
}: KoreRiveCanvasProps): React.JSX.Element {
