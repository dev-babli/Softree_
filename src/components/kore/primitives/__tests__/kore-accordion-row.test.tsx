 ...
 *
 * Unit tests for the `KoreAccordionRow` primitive (task 3.10).
 *
...
import { KoreAccordionRow } from '../kore-accordion-row';
...
describe('KoreAccordionRow', () => {
    ...
    it('honors defaultOpen=true for uncontrolled usage', () => {
        render(
            <KoreAccordionRow heading="Products" defaultOpen>
                <a href="/a">Link A</a>
            </KoreAccordionRow>,
        );
    ...
    it('wires aria-controls/aria-labelledby between the trigger and the body (Req 25.6)', () => {
        render(
            <KoreAccordionRow heading="Products" idBase="prods">
                <a href="/a">Link A</a>
            </KoreAccordionRow>,
        );
    ...
    it('reflects the controlled `open` prop and fires onToggle without using internal state', () => {
        ...
        const { rerender } = render(
            <KoreAccordionRow heading="Products" open={false} onToggle={onToggle}>
                <a href="/a">Link A</a>
            </KoreAccordionRow>,
        );
        ...
        rerender(
            <KoreAccordionRow heading="Products" open onToggle={onToggle}>
                <a href="/a">Link A</a>
            </KoreAccordionRow>,
        );
        expect(getRow().getAttribute('data-accordion')).toBe('active');
        ...
        function Harness() {
            ...
            return (
                <>
                    ...
                    <KoreAccordionRow heading="Products" open={open} idBase="prods">
                        <a href="/a">Link A</a>
                    </KoreAccordionRow>
                </>
            );
    ...
    it('renders the cross icon (.accordion-cross-icon) when icon="cross"', () => {
        render(
            <KoreAccordionRow heading="Products" icon="cross">
                <a href="/a">Link A</a>
            </KoreAccordionRow>,
        );
    ...
    it('appends a custom className to the data-accordion-list container', () => {
        render(
            <KoreAccordionRow heading="Products" className="footer-col">
                <a href="/a">Link A</a>
            </KoreAccordionRow>,
        );

        const container = getContainer();
        expect(container.classList.contains('kore-accordion-row')).toBe(true);
