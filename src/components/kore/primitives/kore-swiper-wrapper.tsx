...
/**
 * Props for {@link KoreSwiperWrapper}.
 */
export interface KoreSwiperWrapperProps {
    /**
...
/**
 * `KoreSwiperWrapper` — the shared Swiper 12 carousel primitive used by the
 ...
 */
export function KoreSwiperWrapper({
    slides,
    config,
    modules,
    className,
    ...
    onSwiper,
}: KoreSwiperWrapperProps): React.JSX.Element {
