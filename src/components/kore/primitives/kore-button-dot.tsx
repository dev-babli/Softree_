...
/**
 * `KoreButtonDot` — the dot-and-line CTA button used throughout the Kore.ai
 ...
 */
export interface KoreButtonDotProps {
...
export function KoreButtonDot({
    ...
    variant = 'primary',
    className,
}: KoreButtonDotProps): React.JSX.Element {
    const classes = ['button', 'w-inline-block', 'group/kore-btn', className]
        .filter(Boolean)
        .join(' ');
        ...
        <>
            ...
            <div className="btn_dot-block">
                <div className="btn-dot-wrapper">
                    <div
                        className="btn-dot opacity-0 transition group-hover/kore-btn:opacity-100 motion-reduce:transition-none"
                        style={DOT_LINE_TRANSITION}
                    />
                </div>
                <div className="btn_dot-line-wrapper">
                    <div
                        className="btn_dot-line transition group-hover/kore-btn:opacity-0 group-hover/kore-btn:[transform:translateX(var(--spacing-s0p5rem))] motion-reduce:transition-none"
                        style={DOT_LINE_TRANSITION}
                    />
                </div>
            </div>
