...
/**
 * Props for {@link KoreHoverImageTarget}.
 */
export interface KoreHoverImageTargetProps {
    /**
...
/**
 * `KoreHoverImageTarget` — wraps a single `hover-img-button` element and
 * imperatively registers its rendered DOM node with the Hover_Image_Preview
 * registry exposed via {@link HoverImageContext}.
 *
 * The registry (provided by `KoreHoverImagePreview`, task 18.1) attaches the
 ...
 */
export function KoreHoverImageTarget({
    dataImg,
    children,
    className,
}: KoreHoverImageTargetProps): React.JSX.Element {
