 ...
 *
 * Source: `public/kore-source-sections.html` `<div class="nav">` —
 ...
 * and are defined + exported here; `KoreNavigation` (task 6.2) imports them.
 *
 ...
 *     (`<a class="menu-link parent" href="https://marketplace.kore.ai/"
 ...
 *     behavior.
 *
 *  2. LANGUAGE TOGGLE IS FOOTER-ONLY. design.md `KoreNavigationProps` requires
...
/** Props for `KoreNavigation` (design.md, with the documented deviations). */
export interface KoreNavigationProps {
...
const guideForresterImg: ImageAssetRef = {
    ...
    alt: 'forrester cx wave 2024 Kore at top',
    loading: 'lazy',
};
                        ...
                        subGroups: [
                            {
                                ...
                                heading: 'Modules',
                                links: [
                                    { label: 'Enterprise Search', href: 'https://kore.ai/ai-for-work/#ai4w-enterprise-search' },
                                    { label: 'Intelligent Orchestrator', href: 'https://kore.ai/ai-for-work/#ai4w-intelligent-orchestrator' },
                                    { label: 'Pre-Built AI Agents', href: 'https://kore.ai/ai-for-work/#ai4w-pre-built' },
                                    { label: 'Admin Controls', href: 'https://kore.ai/ai-for-work/#ai4w-admin-controls' },
                                    { label: 'AI Agent Builder', href: 'https://kore.ai/ai-for-work/#ai4w-ai-agent-builder' },
                                ],
                            },
                            {
        ...
        columns: [
            {
                ...
                cards: [
                    ...
                    },
                    {
                        ...
                        body: 'Leverage pre-built AI agents, templates, and integrations from the Kore.ai Marketplace.',
                    },
                    {
                ...
                groups: [
                    ...
                    },
                    {
                        ...
                        heading: 'Application Accelerators',
                        links: [
                            { label: 'Pre-built agents', href: 'https://marketplace.kore.ai/', target: '_blank' },
                            { label: 'Templates', href: 'https://marketplace.kore.ai/', target: '_blank' },
                            { label: 'Integrations', href: 'https://marketplace.kore.ai/', target: '_blank' },
                        ],
                    },
                    {
            ...
            },
            {
                ...
                links: [
                    { label: 'About Kore.ai', href: '/about-us' },
                    { label: 'Customer Stories', href: '/customer-stories' },
                    { label: 'Partners', href: '/partners' },
                    { label: 'Resources', href: '/resource' },
                    { label: 'Blog', href: '/blog' },
                    { label: 'Whitepapers', href: '/whitepaper' },
                    { label: 'Documentation', href: 'https://docs.kore.ai' },
                    { label: 'Analyst Recognition', href: '/analyst-recognition' },
                    { label: 'Get support', href: '/support' },
                    { label: 'Community', href: 'https://community.kore.ai', target: '_blank' },
                    { label: 'Academy', href: 'https://bots.kore.ai/accounts/?return_to=saml&showLogin=true&hideSSOButtons=true&hideResourcesPageLink=true&comingFromKey=saml' },
                ...
                groups: [
                    ...
                    },
                    {
                        ...
                        links: [
                            ...
                            { label: 'Academy', href: 'https://bots.kore.ai/accounts/?return_to=saml&showLogin=true&hideSSOButtons=true&hideResourcesPageLink=true&comingFromKey=saml', target: '_blank' },
                            { label: 'Community', href: 'https://community.kore.ai', target: '_blank' },
                        ],
                    },
                ],
        ...
        recentInsights: [
            {
                ...
                title: 'Kore.ai named a leader in The Forrester Wave™: Conversational AI for Customer Service, Q2 2024',
...
export const navigationData: KoreNavigationProps = {
    logo: {
        href: '/',
        ariaLabel: 'kore.ai homepage',
    },
