 ...
 *
 * Source: `public/kore-source-sections.html` `<footer class="footer">` —
 ...
 *     Pre-Built Applications, Kore.ai agent platform, Industries, company,
 ...
 *     `href="#"`, `aria-label="kore.ai homepage"`) with no external asset URL,
...
export const footerData: KoreFooterProps = {
    ...
    columns: [
        ...
        {
            heading: 'Kore.ai agent platform',
            links: [
        ...
        },
        {
            ...
            links: [
                ...
                { label: 'CXO Toolkit', href: 'https://kore.ai/whitepaper/cxo-toolkit' },
            ],
        },
        {
            ...
            links: [
                ...
                {
                    label: 'Academy',
                    href: 'https://bots.kore.ai/accounts/?return_to=saml&showLogin=true&hideSSOButtons=true&hideResourcesPageLink=true&comingFromKey=saml&samlReqId=sar-eee28ed1-023f-5074-840f-95108c381173&RelayState=A1H33GV1WRfMkFobaqVGRuXAs1yf5GdeonEBRxJMoVabE0UD2oZ85-Qd',
                },
                {
                    label: 'Community',
    ...
    social: [
        {
            ...
            href: 'https://in.linkedin.com/company/kore-inc',
            target: '_blank',
