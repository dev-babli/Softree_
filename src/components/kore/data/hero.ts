 ...
 *
 * Source: `public/kore-source-sections.html` `<section class="section-home-hero
 * _100vh pb-0">` —
 ...
 *     `image`. The source card also has an eyebrow span ("The Kore.ai Agent
 ...
 *     is a local `.riv` file under `/kore/rive/` (task 1.8). Per the explicit
...
export interface RiveCardData {
    ...
    /** Local fallback staged under `/kore/rive/` (Req 6.9, 26.5). */
...
export const heroData: KoreHeroProps = {
    ...
    artemisAnnouncement: {
        eyebrow: 'The Kore.ai Agent Platform',
        badge: 'NEW',
