 ...
 *
 * Source: `public/kore-source-sections.html` — four `<dialog class="modal">`
 * nodes, in DOM order:
 *   1. `#enterprise-modal`       → kind 'content' (Kore.ai marketecture / tech stack)
 ...
 * the `assets.modals` Tech-stack (`.bg`) + Kore_ai Marketecture webp images.
 *
 ...
 *    passthrough + `/kore/` local assets, Req 24). They cannot be typed as the
...
/** Props for `KoreModalsLayer` (design.md). */
export interface KoreModalsLayerProps {
...
const marketectureBase =
    assets.modals['698b3841f0a01edefe465a15-kore-ai-marketecture-webp'];
const marketectureImage: ImageAssetRef = {
    ...
    loading: 'lazy',
    srcset: [
        `${assets.modals['698b3841f0a01edefe465a15-kore-ai-marketecture-p-500-webp'].url} 500w`,
        `${assets.modals['698b3841f0a01edefe465a15-kore-ai-marketecture-p-800-webp'].url} 800w`,
        `${assets.modals['698b3841f0a01edefe465a15-kore-ai-marketecture-p-1080-webp'].url} 1080w`,
        `${assets.modals['698b3841f0a01edefe465a15-kore-ai-marketecture-p-1600-webp'].url} 1600w`,
        `${assets.modals['698b3841f0a01edefe465a15-kore-ai-marketecture-p-2000-webp'].url} 2000w`,
        `${assets.modals['698b3841f0a01edefe465a15-kore-ai-marketecture-p-2600-webp'].url} 2600w`,
        `${assets.modals['698b3841f0a01edefe465a15-kore-ai-marketecture-p-3200-webp'].url} 3200w`,
