  ...
  return (
    <label className="block" htmlFor={id}>
      <span className="mb-1.5 block text-[11px] font-semibold uppercase tracking-widest text-white/50">
        {placeholder}{required && <span className="ml-0.5 text-[#ff5812]">*</span>}
      </span>
      <input
        id={id}
        name={name}
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (typeof window !== "undefined") {
          ; (window as unknown as { dataLayer?: Array<Record<string, unknown>> }).dataLayer?.push({ event: "form_submit", form_name: "contact" })
        }
              ...
              >
                ...
                <div>
                  ...
                  <p className="mt-3 text-[11px] text-white/35 leading-5">
                    ...
                    <a href="/privacy-policy" className="underline hover:text-white/60 transition-colors">Privacy Policy</a>.
                  ...
                  {status === "success" && (
                    ...
                    >
                      Message received. We&apos;ll reply within 1 business day and may send a calendar invite for a 15-min scoping call.
                    </p>
                  )}
