...
export default function StandardStoryLayout({
  ...
  const ptComponents = {
    ...
    listItem: { bullet: ({ children }: { children?: React.ReactNode }) => <li className="pl-1">{children}</li>, number: ({ children }: { children?: React.ReactNode }) => <li className="pl-1">{children}</li> },
