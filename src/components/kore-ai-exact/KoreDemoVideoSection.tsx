...
import "./kore-demo-video-fix.css"
...
export function KoreDemoVideoSection() {
  ...
  const section = useMemo(() => {
    const raw = KORE_AI_SECTIONS.find((item) => item.name === "KoreSection7Section")
    if (!raw) return null
    return { ...raw, html: applySoftreeSectionHtml("KoreSection7Section", raw.html) }
  }, [])
